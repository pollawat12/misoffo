                    ...
                    <table id="datatable" class="table table-bordered table-striped  dt-responsive nowrap"
                        ...
                        <thead>
                            <tr class="bg-dark text-white">
                                ...
                                <th style="width: 20%">จำนวนที่ลา</th>
                        ...
                        <tbody>
                            ...
                            <?php $no++;
                                 ...
                                 $LeaveNum = \App\Models\Userleave::where('users_id', $id)->where('leave_type', $item['id'])->where('is_approved', '1')->where('is_deleted', '0')->where('is_active','1')->get();
