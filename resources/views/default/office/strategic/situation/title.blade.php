        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box table-responsive">
                    <div class="row mb-3">
                        <div class="col-6">
                            <h4 class="header-title">รายการข้อมูล :: สถานการณ์ LPG </h4>
                    ...
                    <table id="datatable" class="table table-bordered table-striped  dt-responsive nowrap"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle"><?php echo $item->year + 543;?></td>
                                <td class="align-middle">
                                    {!! getLabelStatusOnOff(0) !!}
                                </td>
                                <td class="align-middle">
                                    <a href="{{URL('office/strategic/oil/lists')}}/?t={{$pr}}&pr={{$item->year}}" class="btn btn-outline-warning waves-effect width-md waves-light btn-sm"><i class="mdi mdi-pencil-plus-outline">ดูรายละเอียด</i> </a>
                                </td>
                            </tr>
                            @endforeach
                            @endif
