                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0);">บริหารงานยุทธศาสตร์</a></li>
                            <li class="breadcrumb-item active">นำเข้ารายการข้อมูล</li>
                        </ol>
                    </div>
                    <h4 class="page-title">นำเข้ารายการข้อมูล</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-box">
                    ...
                    <form action="{{url('office/manage-strategy/subject/save')}}" method="POST" name="frm-save2" id="frm-save2" enctype="multipart/form-data">

                        <input type="hidden" name="edit_id" value="0">
                        <input type="hidden" name="data_type_id" value="{{ $type_id }}">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="input-budget-year">รายการข้อมูล</label>
                                    <input type="text" name="" disabled value="{{ $type_info->name }}" class="form-control" id="input-budget-year" >
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="incomes_file">เลือกไฟล์ นำเข้าข้อมูล</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="is_deleted">สถานะนำเข้าข้อมูล</label>
                                    <select name="is_deleted" class="form-control" id="is_deleted">
