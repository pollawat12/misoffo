...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-box">
                    <h4 class="header-title mb-4"><i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; "> ทะเบียนคุมทรัพย์สิน</i> </h4>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table style="width: 100%;">
                                    <thead>
                                    <tr>
                                        <th colspan="3" align="center" style="height: 55px;">ทะเบียนคุมทรัพย์สิน</th>
                                    </tr>
                                    <tr>
                                        <td colspan="3" style="height: 55px;"><b>ส่วนราชการ : </b>  {{$item['projects']}}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><b>รหัส : </b>  {{$item['durable_number']}}</td>
                                        <td><b>ลักษณะ / คุณสมบัติ : </b>   &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;   <b>รุ่น / แบบ : </b> </td>
                                    </tr>
                                    <tr>
                                        <td style="height: 55px;"><b>สถานที่ตั้ง/หน่วยงานที่รับผิดชอบ : </b>  {{$item['borrow_institution']}}  </td>
                                        <td colspan="2" ><b>ชื่อผู้ขาย / ผู้รับบริจ้าง / ผู้บริจาค : </b>  {{$item['durable_company']}}</td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" style="height: 55px;"><b>ที่อยู่ : </b>  {{$item['borrow_location']}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                        <td style="height: 55px;"><b>โทร : </b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$info->durable_num}}</td>
                                                    <td>{{number_format($info->durable_price,2,'.',',')}}</td>
                                                    <td>{{number_format($info->durable_price * $info->durable_num,2,'.',',')}}</td>
                                                    <td>{{$info->durable_year}}</td>
                                                    <td>{{$info->durable_depreciation_rate}}</td><td><?php if($z == 1){ echo number_format(($info->durable_price * (($info->durable_depreciation_rate /100) * $z)),2,'.',','); }else{ echo number_format(($info->durable_price * (($info->durable_depreciation_rate /100) * ($numz-$z))),2,'.',','); }?></td>
                                                    <td>{{number_format(($info->durable_price * (($info->durable_depreciation_rate /100) * $z)),2,'.',',')}}</td>
                                                    <td><?php $sum = $info->durable_price - $info->durable_price * (($info->durable_depreciation_rate /100) * $z);  echo number_format($sum,2,'.',','); ?></td>
                                                    <td></td>
                                                </tr>
