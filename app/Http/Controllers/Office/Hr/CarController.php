...
class CarController extends Base
{
    /**
     * __construct
     *
    ...
    public function all(Request $request)
    {
        ...
        // display
        $file = 'default.office.hr.reserve-car.all';
    ...
    public function report(Request $request)
    {
        ...
        // display
        $file = 'default.office.hr.reserve-car.report';
    ...
    public function departments($id, $depid, Request $request)
    {
        ...
        // display
        $file = 'default.office.hr.reserve-car.departments';
    ...
    public function index($id, Request $request)
    {
        ...
        // display
        $file = 'default.office.hr.reserve-car.index';
    ...
    public function create($id, $typeid, Request $request)
    {
        ...
        $arr = ['employees', 'categoryLeave', 'id', 't', 'typeid', 'department_boss', 'groupWork_boss', 'boss_misoffo', 'auth_info', 'meeting_types'];

        // display
        $file = 'default.office.hr.reserve-car.add';
    ...
    public function edit($id, Request $request)
    {
        ...
        $LeaveList = Usercar::where('users_id', $auth_info )->whereIn('is_approved', ['0','1','2','3','4'])->where('is_deleted', '0')->where('is_active', '1')->get();

        $arr = ['employees', 'categoryLeave', 'id', 'info', 't', 'pr', 'de', 'department_boss', 'LeaveList', 'auth_info', 'holiday'];

        // display
        $file = 'default.office.hr.reserve-car.edit';
    ...
    public function cancel($id, Request $request)
    {
        ...
        // display
        $file = 'default.office.hr.reserve-car.cancel';
        ...
        if ($request->ajax() && $request->isMethod('post')) {
            ...
            if ($startProject > $endProject) {
                ...
                if ($id == 0) {
                    ...
                    $result = Usercar::insertRow($data, true);

                    $employee = Usercar::getCheckEmplyooLeave($result);
                    ...
                    //return response()->json($action, 200);
                    $result = Usercar::updateRow($data, $id, $auth_info, $leave_user_id, $action);
                    // -- upload file -- //
                    if ($request->hasFile('upfile_leave')) {
                        // create folder
                        $pathUpload = MyUtilities::mkDirPathUpload($data['user_id'], 'upfilesLeave');
                        ...
                        $result = Usercar::where('id', (int) $id)->update(array('leave_file' => $uploadFilename));
                    }

                    $employee = Usercar::getCheckEmplyooLeave($id);
                    foreach ($employee as $row);
    ...
    public function workall(Request $request)
    {
        ...
        // display
        $file = 'default.office.hr.reserve-car.workall';
    ...
    public function workindex($id, Request $request)
    {
        ...
        // display
        $file = 'default.office.hr.reserve-car.workindex';
    ...
    public function searchAll(Request $request)
    {
        ...
        $Leave = Usercar::getSearchDay($data);

        $arr = ['Leave'];

        // display
        $file = 'default.office.hr.reserve-car.Day';
    ...
    public function info(Request $request)
    {
        ...
        if ($userid == 0) {
            ...
            $LeaveNum = Usercar::where('users_id', $userid)->where('leave_type', $id)->whereIn('is_approved', ['0','1','2','3','4'])->where('is_deleted', '0')->where('is_active', '1')->get();

            $LeaveList = Usercar::where('users_id', $userid)->whereIn('is_approved', ['0','1','2','3','4'])->where('is_deleted', '0')->where('is_active', '1')->get();
