...
{    
    ...
    public function index()
    {
        ...
        # code...
        $data = ['rooms'];
        return view('default.office.setting.meeting.room.index', compact($data))->render();
    }
    ...
    public function add(Request $request)
    {
        ...
        # code...
        $data = [];
        return view('default.office.setting.meeting.room.add', compact($data))->render();
    }
    ...
    public function edit($id, Request $request)
    {
        ...
        $room_info = DataSetting::find((int) $id);
        
        # code...
        $data = ['room_info', 'id'];
        return view('default.office.setting.meeting.room.edit', compact($data))->render();
    }
