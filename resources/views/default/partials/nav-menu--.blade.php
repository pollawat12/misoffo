            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li>
                            <a href="javascript: void(0);" aria-expanded="false">น้ำมันเชื้อเพลิง 
                                <span class="menu-arrow"></span>
                            </a>
                            <ul class="nav-third-level nav" aria-expanded="false">
                                <li><a href="{{URL('office/strategic/oil/lists')}}/?t=oilContent&pr=5"><i class="fas fa-angle-right"></i> ปริมาณการใช้น้ำมันเชื้อเพลิง</a></li>
                            </ul>
                        </li> 
                        <li>
                            <a href="javascript: void(0);" aria-expanded="false">ปริมาณการจัดหาก๊าซ LPG
                                <span class="menu-arrow"></span>
                            </a>
                            <ul class="nav-third-level nav" aria-expanded="false">
                                <li><a href="{{URL('office/strategic/oil/lists')}}/?t=situation&pr=6"><i class="fas fa-angle-right"></i> สถานการณ์ LPG</a></li>
                                <li><a href="{{URL('office/strategic/oil/lists')}}/?t=supply&pr=7"><i class="fas fa-angle-right"></i> LPG จัดหา</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="javascript: void(0);" aria-expanded="false">อัตราเงินกองทุนฯ
                                <span class="menu-arrow"></span>
                            </a>
                            <ul class="nav-third-level nav" aria-expanded="false">
                                <li><a href="{{URL('office/strategic/oil/lists')}}/?t=oils&pr=8"><i class="fas fa-angle-right"></i> อัตราน้ำมัน</a></li>
                                <li><a href="{{URL('office/strategic/oil/lists')}}/?t=lpg&pr=9"><i class="fas fa-angle-right"></i> อัตราก๊าซ LPG</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="javascript: void(0);" aria-expanded="false">ราคาขายปลีก 
                                <span class="menu-arrow"></span>
                            </a>
                            <ul class="nav-third-level nav" aria-expanded="false">
                                <li><a href="{{URL('office/strategic/oil/lists')}}/?t=lpgRetail&pr=10"><i class="fas fa-angle-right"></i> ก๊าซ LPG</a></li>
                            </ul>
                        </li> 
                        <li>
                            <a href="javascript: void(0);" aria-expanded="false">ตั้งค่า 
                            ...
                            <ul class="nav-third-level nav" aria-expanded="false">
                                ...
                                <li><a href="{{URL('office/settings/data/lists')}}/?t=oilGroup&pr=0"><i class="fas fa-angle-right"></i>  กลุ่มน้ำมัน</a></li>
                                <li><a href="{{URL('office/settings/data/lists')}}/?t=domestic&pr=0"><i class="fas fa-angle-right"></i>  การจัดหาภายในประเทศ</a></li>
                                <li><a href="{{URL('office/settings/data/lists')}}/?t=portage&pr=0"><i class="fas fa-angle-right"></i>  การนำเข้า/ส่งออก</a></li>
                                <li><a href="{{URL('office/settings/data/lists')}}/?t=business&pr=0"><i class="fas fa-angle-right"></i>  ประเภทธุรกิจ</a></li>
                                <li><a href="{{URL('office/settings/data/lists')}}/?t=situation&pr=0"><i class="fas fa-angle-right"></i>  ประเภทสถานการณ์</a></li>
                                <li><a href="{{URL('office/settings/data/lists')}}/?t=oils&pr=0"><i class="fas fa-angle-right"></i>  น้ำมัน</a></li>
                                <li><a href="{{URL('office/settings/data/lists')}}/?t=lpg&pr=0"><i class="fas fa-angle-right"></i>  LPG</a></li>
                                <li><a href="{{URL('office/settings/data/lists')}}/?t=lpgRetail&pr=0"><i class="fas fa-angle-right"></i>  LPG retail</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
