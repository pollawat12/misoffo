                    ...
                    <table id="datatable" class="table table-bordered table-striped  dt-responsive nowrap"
                        ...
                        <thead>
                            <tr class="bg-dark text-white">
                                ...
                                <th style="width: 10%">สถานปฏิบัติงาน</th>
                                <th style="width: 10%">Remark</th>
                                <th style="width: 10%">เวลาทำงาน</th>
                            ...
                            @for($no=1; $no <= $day; $no++)
                                ...
                                ?>
                                    <tr>
                                        ...
                                        if ($timeInfos and $timeInfo) {
                                            $strDate = getShowDateMonthTH($timeInfos->check_in_date, false);
                                            list($hh1, $mm1, $ii1) = explode(':', trim($timeInfos->check_in_time));
                                            list($hh2, $mm2, $ii2) = explode(':', trim($timeInfo->check_in_time));
                                            $t1 = ($hh1*60) + $mm1;
                                            $t2 = ($hh2*60) + $mm2;
                                            $t3 = $t1 - $t2;
                                            ...
                                            if ($hh1 >= 17) {
                                                ...
                                                if ($timeInfos->check_time_type == 'office') {
                                                $oth = $hh1-17;
                                                $otm = $mm1;
