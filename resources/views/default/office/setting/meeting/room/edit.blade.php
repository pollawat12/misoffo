        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">แก้ไข ห้องประชุม</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-box">
                    ...
                    <form action="{{url('office/settings/meeting_room/update')}}" method="POST" name="frm-save" id="frm-save">
                        <input type="hidden" name="edit_id" value="{{$id}}">
                        <input type="hidden" name="group_type" value="meeting_room">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name">ห้องประชุม <code>*</code></label>
                                    <input type="text" name="name" class="form-control" id="name" placeholder="" value="{{$room_info->name}}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="amount" class="form-control" id="amount" placeholder="" value="{{$room_info->amount}}">
                                    <small id="emailHelp" class="form-text text-muted"></small>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="is_deleted" class="form-control" id="input-is_deleted" style="height: 40px;">
                                        <option value="0" @if($room_info->is_deleted == 0) selected @endif>เปิดใช้งาน</option>
                                        <option value="1" @if($room_info->is_deleted == 1) selected @endif>ปิดใช้งาน</option>
                                    </select>
                                    <small id="emailHelp" class="form-text text-muted"></small>
                                </div>
                            </div>
