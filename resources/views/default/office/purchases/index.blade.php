                ...
                <div class="card-box table-responsive">
                    <div class="row mb-3">
                        ...
                        <div class="col-6 text-right">
                            <a href="{{URL('office/purchases/add')}}" class="btn btn-sm btn-primary width-md waves-light"><i class="mdi mdi-database-plus"> เพิ่มข้อมูล</i></a>
                        </div>
                    </div>
                    ...
                    <table id="datatable" class="table table-bordered table-striped  dt-responsive nowrap"
                        ...
                        <thead>
                            <tr class="bg-dark text-white">
                                ...
                                <!-- <th >งบประมาณที่ได้รับจัดสรรร</th>
                                <th >ราคากลาง</th> -->
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <!-- <td class="align-middle" style="width: 12%;">{{getDateShow($item['purchases_invoice_date'])}}</td> -->
                                <td class="align-middle" style="width: 12%;">{{$item['purchases_name']}}</td>
                                <td class="align-middle" style="width: 12%;">{{$item['purchases_company']}}</td>
                                <!-- <td class="align-middle" style="width: 10%;">{{number_format($item['purchases_allocated_budget'],2,'.',',')}}</td>
                                <td class="align-middle" style="width: 10%;">{{number_format($item['purchases_middle_price'],2,'.',',')}}</td> -->
                                <td class="align-middle" style="width: 12%;">{{$item['purchases_method']}}</td>
                                <td class="align-middle" style="width: 10%;">{{number_format($item['purchases_contract_amount'],2,'.',',')}}</td>
                                <td class="align-middle" style="width: 10%;">{{$item['purchases_purchasing_status']}}</td>
                                <td class="align-middle" style="width: 10%;">

                                    <select name="input_action" class="form-control" data-id="{{$item['id']}}">
                                        <option value="">เลือก</option>
                                        <option value="detail" data-original-title="">อัพเดทสถานะ</option>
