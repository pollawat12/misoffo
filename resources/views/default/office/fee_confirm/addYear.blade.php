...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">การเบิกจ่าย : ค่าใช้จ่ายในการบริหารกองทุนพัฒนาน้ำบาดาล</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
            ...
            <div class="col-md-12">
                <div class="card-box">
                    ...
                    <form action="{{url('office/budget/confirm/save')}}" method="POST" name="frm-save" id="frm-save">
                        ...
                        <input type="hidden" name="input[year_budgets_id]" value="{{$id}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="input[duration]" class="form-control" id="input-area_process" cols="30" rows="4">{{getDateMonthTH($valDetail->date_start)}} - {{getDateMonthTH($valDetail->date_end)}}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <a href="{{URL('office/budget/confirm/show')}}/{{$id}}/?t=1"  class="btn btn-secondary"><i class=" mdi mdi-backspace-outline
                            "> ยกเลิก</i></a>
                    </form>
                </div>
            </div>
        ...
        <!-- end row -->
        <div id="url-redirect-back" data-url="{{url('office/budget/confirm/show')}}/{{$id}}/?t=1"></div>
    </div>
</div>
@endsection
