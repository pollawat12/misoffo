...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-box">
                    <h4 class="header-title mb-4"><i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; "> เพิ่มข้อมูล ตั้งงบประมาณ</i> </h4>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="input[budgets_id]" id="budgets_id" class="form-control" style="height: 45px;">
                                        ...
                                        <option value="{{$vabudget->id}}">{{$vabudget->name}}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                    <small id="year_id" class="form-text text-muted"></small>
        ...
        <div id="url-redirect-back" data-url="{{url('office/budget/expenses/year/edit/get')}}"></div>
    </div>
</div>
@endsection
