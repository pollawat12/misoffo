...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">แสดง เพิ่มพัสดุ</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card-box">
                    ...
                    <form action="{{url('office/durable/save')}}" method="POST" name="frm-save" id="frm-save" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="input[means_id]" id="means_id" class="form-control" style="height: 45px;">
                                                ...
                                                <option value="{{$valMeans->id}}">{{$valMeans->name}}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="input[category_id]" id="category_id" class="form-control" style="height: 45px;">
                                                <option value="">--เลือก--</option>
                                                @if (count($category) > 0)
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <span id="durable_number">
                                                <input type="text" name="input[durable_number]" class="form-control" placeholder="" style="height: 45px;">
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="input[durable_serial]" class="form-control" placeholder="" style="height: 45px;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="input[durable_generation]" id="durable_generation" class="form-control" placeholder="" style="height: 45px;">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <div class="input-group">
                                                    <input type="text" class="form-control datepicker-autoclose" placeholder="วว/ดด/ปปปป" name="input[durable_received_date]" style="height: 45px;">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="input[durable_num]" class="form-control" id="durable_num" placeholder="" style="height: 45px;" value="1">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="durable_price">ราคา/หน่วย/ชุด/กลุ่ม <code>*</code></label>
                                            <input type="text" name="input[durable_price]" class="form-control" id="durable_price" placeholder="" style="height: 45px;">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="input[durable_year]" class="form-control" placeholder="" style="height: 45px;">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="input[durable_depreciation_rate]" class="form-control" placeholder="" style="height: 45px;">
        ...
        <div id="url-redirect-back" data-url="{{url('office/durable/report')}}"></div>
...
<script>
    ...
    $(function() {
        ...
        function callBackFunc(data) {
            ...
            if (data.status) {
                setTimeout(() => {
                    window.location.href = urlRedirect + '/' + data.id + '?t={{$t}}&pr={{$pr}}';
                }, 2300);
