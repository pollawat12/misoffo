            ...
            <div class="col-lg-12">
                <div class="card-box">
                    <div class="media-body">
                        <div class="p-4">
                            <h4 class="font-16 mb-3 text-center">บันทึกทะเบียนคุมทรัพย์สิน</h4>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="border-rl border-bottom">{{number_format(($info->durable_price * (($info->durable_depreciation_rate /100) * $z)),2,'.',',')}}</td>
