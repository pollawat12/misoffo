                        ...
                        <table id="datatable" class="table table-bordered table-striped  dt-responsive nowrap"
                            ...
                            <thead>
                                <tr class="bg-dark text-white">
                                    ...
                                    <th style="vertical-align : middle;text-align:center;">สถานะครุภัณฑ์</th>
                                    <th style="vertical-align : middle;text-align:center;">สถานที่ใช้งาน</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle" style="vertical-align : middle;text-align:center;">@if ($item['durable_status'] == 0) @elseif($item['durable_status'] == 1) ยืม @else ตัดจำหน่าย @endif</td>
                                    <td class="align-middle" style="vertical-align : middle;text-align:center;">
                                        <?php
                                            if($item['borrow_project'] == null && $item['borrow_user_name'] == null ){
        
                                            }else{
        
                                                if($item['borrow_project'] == '0'){
                                                
                                                    echo $project = 'ภายในสำนักงาน';
                                                    
                                                }else{
            
                                                    $Projects = \App\Models\Project::find((int) $item['borrow_project']);
                                    ...
                                    <td class="align-middle">@if ($item['durable_status'] == 0) @elseif($item['durable_status'] == 1) {{$item['borrow_institution']}} @else {{$item['distribution_institution']}} @endif</td>
                                </tr>
                                @endforeach
                                @endif
