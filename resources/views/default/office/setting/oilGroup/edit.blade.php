...
<div class="content">
    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">กลุ่มน้ำมัน</li>
                        </ol>
                    </div>
                    <h4 class="page-title">แก้ไข กลุ่มน้ำมัน</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-box">
                    <h4 class="header-title mb-4"><i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; "> แก้ไขข้อมูล กลุ่มน้ำมัน</i> </h4>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">กลุ่มน้ำมัน <code>*</code></label>
                                    <input type="text" name="input[name]" class="form-control" id="input-name" placeholder="กลุ่มน้ำมัน" style="height: 45px;" value="{{$info->name}}">
