                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="input[category_id]" class="form-control" id="category_id" style="height: 45px;">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <span id="durable_number">
                                                <input type="text" name="input[durable_number]" class="form-control" placeholder="" style="height: 45px;" value="{{$info->durable_number}}">
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
