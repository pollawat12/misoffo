                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <a href="{{URL('office/hr/leave-work')}}/{{$item['id']}}/?t=admin" class="btn btn-outline-warning waves-effect width-md waves-light btn-sm"><i class="mdi mdi-pencil-plus-outline">กำหนดสิทธิการลา</i> </a>
                                </td>
                            </tr>
                            @endforeach
                            @endif
