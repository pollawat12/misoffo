                    ...
                    <table id="datatable" class="table table-bordered table-striped  dt-responsive nowrap"
                        ...
                        <thead>
                            <tr class="bg-dark text-white">
                                ...
                                <th class="text-center align-middle">ปีงบประมาณ</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle"><a href="{{URL('office/hr/jobs')}}/{{$item['id']}}">{{$item['name']}}</a></td>
                                ...
                                <?php
                                    $institution = \App\Models\YearBudget::find((int) $item['year_id']);
                                ...
                                <td class="align-middle text-center">
                                    <?php if($item['status_approved'] == 1){ ?>
                                        <span class="badge badge-success p-1 font-size-14">
                                            เปิดใช้งาน
                                        </span>
                                    <?php }else{ ?>
                                        <span class="badge badge-off p-1 font-size-14">
                                            ปิดใช้งาน
                                        </span>
                                ...
                                <td class="align-middle text-center">
                                    ...
                                    <!-- <a href="{{URL('office/hr/announce/views')}}/{{$item['id']}}">
                                    ...
                                    <a href="{{URL('office/hr/announce/edit')}}/{{$item['id']}}">
                                    <button type="button" class="btn btn-warning waves-effect waves-light" data-toggle="tooltip" data-placement="top" title data-original-title="edit">
                                        <i class="mdi mdi-pencil-outline"></i> 
                                    </button>
                                    </a>
                                    <a href="{{URL('office/hr/announce/delete')}}/{{$item['id']}}"><button type="button" class="btn btn-danger waves-effect waves-light" data-toggle="tooltip" data-placement="top" title data-original-title="delete">
