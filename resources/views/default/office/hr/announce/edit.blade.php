                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">แก้ไขประกาศรับสมัครงาน
                            </li>
                        </ol>
                    </div>
                    <h4 class="page-title">แก้ไขประกาศรับสมัครงาน</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card-box">
                    ...
                    <form action="{{url('office/hr/announce/update')}}" method="POST" name="frm-save" id="frm-save" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                                ...
                                                <div>
                                                    <div class="input-group">
                                                        <input type="text" class="form-control datepicker-autoclose"
                                                            placeholder="วว/ดด/ปปปป" name="input[day_start]" value="{{getDateFormatToInputThai($info->day_start)}}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <div class="input-group">
                                                        <input type="text" class="form-control datepicker-autoclose"
                                                            placeholder="วว/ดด/ปปปป" name="input[day_end]" value="{{getDateFormatToInputThai($info->day_end)}}">
                                                        <div class="input-group-append">
                                                            <span class="input-group-text"><i
                                                                    class="mdi mdi-calendar"></i></span>
                                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="input[note]" id="" rows="5" class="form-control">{{$info->note}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="input[status_approved]" id="" class="form-control">
                                            <option @if(0 == $info->status_approved) selected @endif value='0'>เปิดใช้งาน</option>
                                            <option @if(1 == $info->status_approved) selected @endif value='1'>ปิดใช้งาน</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
