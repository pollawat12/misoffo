                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="input[durable_size]" class="form-control" placeholder="" style="height: 45px;" value="{{$info->durable_size}}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="input[durable_mix]" class="form-control" placeholder="" style="height: 45px;" value="{{$info->durable_mix}}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="input[durable_max]" class="form-control" placeholder="" style="height: 45px;" value="{{$info->durable_max}}">
