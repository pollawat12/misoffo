                ...
                <div class="card-box">
                    <form action="{{url('office/services/reserve-car/save')}}" method="POST" name="frm-save" id="frm-save">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select name="time_category" class="form-control" id="time_category">
                                        <option value="">ระบุ</option>
                                        <option value="1">ส่งเที่ยวเดียว</option>
                                        <option value="2">ส่งแล้ว ให้มารับกลับ</option>
                                        <option value="3">ส่งแล้ว รอรับกลับ</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3">
                        ...
                        {{-- <div class="row mt-2">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="detail">โปรดระบุรายชื่อ ดังนี้ </label>
                                    <textarea name="detail_num" id="detail_num" cols="30" rows="3"></textarea>
                                    <small id="emailHelp" class="form-text text-muted"></small>
                                </div>
                            </div>
                        ...
                        <div class="row mt-2">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="detail">ขอใช้รถเพื่อเดินทางไป (ระบุสถานที่) </label>
