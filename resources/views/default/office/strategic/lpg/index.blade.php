        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box table-responsive">
                    <div class="row mb-3">
                        <div class="col-6">
                            <h4 class="header-title">รายการข้อมูล :: อัตราก๊าซ LPG   </h4>
                    ...
                    <table id="datatable" class="table table-bordered table-striped  dt-responsive nowrap"
                        ...
                        <thead>
                            <tr class="bg-dark text-white">
                                ...
                                <th style="width: 10%">วันที่มีผล</th>
                                <th style="width: 10%">วันที่ใช้ข้อมูล</th>
                                <?php
                                    $oilTypes = \App\Models\DataSetting::where('group_type', "lpg")->where('is_deleted', '0')->where('is_active','1')->get();
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">{{getDateShow($item->oil_price_date_strart)}} - {{getDateShow($item->oil_price_date_end)}}</td>
                                <?php 
