                        ...
                        <div class="table-responsive">
                            <table class="table m-0 table-colored-bordered table-border-color">
                                <thead>
                                    ...
                                    <tr class="table-bgcolor border-bottom ">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        for ( $i = $startTime; $i <= $endTime; $i = $i + 86400 ) {
                                            ...
                                            $date_stamp = strtotime(date('Y-m-d', strtotime($thisDate)));

                                            //check date is sunday or monday
                                            $stamp = date('D', $date_stamp); 
                                    ?>
                                        <tr>
                                            <td class="text-center table-bordered text-color-td"><?php echo getDateTimeTH($thisDate,false,true);?></td>

                                            <?php if($stamp == 'Sat' || $stamp == 'Sun'){ ?> 

                                                <td class="text-center text-color-td table-bordered" colspan="6"><?php if($stamp == 'Sat'){ echo 'วันเสาร์'; }else{ echo 'วันอาทิตย์'; }?></td>
                                            ...
                                            <?php 
                                                    ...
                                                    // $bubai = \App\Models\BudgetCertificateCompany::where('id', $item['id'])->get();
                                                    // $bubai = \App\Models\BudgetCertificateCompany::where('id', $item['id'])->get();
                                                    // $bubai = \App\Models\BudgetCertificateCompany::where('id', $item['id'])->get();
                                            ...
                                            ?>
                                                ...
                                                <td class="text-center text-color-td font-weight-600 table-bordered">84.900</td>
                                                <td class="text-center text-danger table-bordered ">-</td>
                                                <td class="text-center text-color-td">99.870</td>
                                                <td class="text-center text-danger table-bordered">-</td>
                                                <td class="text-center text-color-td table-bordered">101.430</td>
                                                <td class="text-center text-danger table-bordered">-</td>
                                                <td class="text-center text-color-td font-weight-600 table-bordered">29.84</td>
                                                <td class="text-center text-danger table-bordered">-</td>
