                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">รายการจองรถยนต์</li>
                        </ol>
                    </div>
                    <h4 class="page-title">แสดง รายการจองรถยนต์</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box table-responsive">
                    <div class="row mb-3">
                            <div class="col-6">
                                <h4 class="header-title">รายการข้อมูล :: รายการจองรถยนต์</h4>
                                <p class="sub-header"></p>
                            </div>

                            <div class="col-6 text-right">
                                <a href="{{URL('office/hr/reserve-car/add')}}/{{$id}}/0" class="btn btn-sm btn-primary width-md waves-light"><i class="mdi mdi-database-plus"> จองรถยนต์</i></a>
                                <form action="{{url('office/hr/reserve-car/search/list')}}" target="_blank" method="GET" name="frm-search" id="frm-search">
                                    @csrf
                                    <div class="row mt-2">
                                        <div class="col-md-12">
                                            <div class="row">
                    ...
                    <table id="datatable" class="table table-bordered table-striped  dt-responsive nowrap"
                        ...
                        <thead>
                            <tr class="bg-dark text-white">
                                ...
                                <th style="width: 15%">วันที่ยื่นจอง</th>
                                <th style="width: 10%">ประเภทการจอง</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle" style="width: 15%">{{getDateTimeTH($item['date_start'] , false)}}</td>
                                <td class="align-middle" style="width: 15%">{{getDateTimeTH($item['date_end'] , false)}}</td>
                                <td class="align-middle" style="width: 12%">{{$item['total_date']}} 
                                </td>
                                <td class="align-middle" style="width: 12%">
                                    ...
                                    @elseif($item['is_approved'] == '10') 

                                        <span class="badge bg-warning badge-pill" style="font-size: 14px; padding:8px 16px 8px 16px">ไม่เห็นควรอนุญาต</span>
                                ...
                                <td class="align-middle" style="width: 10%">
                                    @if($item['is_approved'] == '3')  
                                        <select name="input_action" class="form-control" data-id="{{$item['id']}}">
                                            <option value="">เลือก</option>
                                            <option value="cancel" >ยกเลิกการจองรถยนต์</option>
                                        </select>
                                    ...
                                    @elseif($item['is_approved'] == '5')  
                                        <select name="input_action" class="form-control" data-id="{{$item['id']}}" disabled>
                                            <option value="">เลือก</option>
...
$(".datepicker-autoclose").datepicker({
    ...
    $(document).on('change', 'select', function(params) {
        ...
        if(values == 'report'){
            ...
            window.location='{{URL('office/hr/reserve-car/')}}'+ '/' + values + '/' + id;

        }else if(values == 'edit'){

            window.location='{{URL('office/hr/reserve-car/')}}'+ '/' + values + '/' + id + '/?t=user';
