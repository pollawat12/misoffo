                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">ตัดจำหน่ายครุภัณฑ์</li>
                        </ol>
                    </div>
                    <h4 class="page-title">แสดง ตัดจำหน่ายครุภัณฑ์</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box table-responsive">
                    <div class="row mb-3">
                        <div class="col-6">
                            <h4 class="header-title">รายการข้อมูล :: ข้อมูลการตัดจำหน่ายครุภัณฑ์</h4>
                            <p class="sub-header"></p>
                        </div>

                        <div class="col-6 text-right">
                            <a href="{{URL('office/durable/activity/add')}}/?t=distribution&pr=0" class="btn btn-sm btn-primary width-md waves-light"><i class="mdi mdi-database-plus"> เพิ่มข้อมูล</i></a>
                        </div>
                    </div>
                    ...
                    <table id="datatable" class="table table-bordered table-striped  dt-responsive nowrap"
                        ...
                        <thead>
                            <tr class="bg-dark text-white">
                                ...
                                <th style="width: 8%;">วันที่ตัดจำหน่าย</th>
                                <th style="width: 8%;">ชื่อผู้ตัดจำหน่าย</th>
                                <th>สถานที่นำไปตัดจำหน่าย</th>
                                <th>สถานะ</th>
                                <th style="width: 14%;">
                                    จัดการ
                                </th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">{{getDateShow($item['distribution_date'])}}</td>
                                <td class="align-middle">{{$item['distribution_user_name']}}</td>
                                <td class="align-middle">{{$item['distribution_location']}}</td>
                                <td class="align-middle">@if ($item['durable_status'] == 0) @elseif($item['durable_status'] == 1) ยืม @else ตัดจำหน่าย @endif</td>
                                <td class="align-middle">
                                    {{-- <a href="{{URL('office/durable/activity/edit')}}/{{$item['id']}}/?t=distribution&pr=0" class="btn btn-outline-warning waves-effect width-md waves-light btn-sm"><i class="mdi mdi-pencil-plus-outline">แก้ไข</i> </a>
                                    <a href="{{URL('office/durable/activity/delete')}}/{{$item['id']}}" class="btn btn-outline-danger waves-effect width-md waves-light btn-sm" ><i class="mdi mdi-trash-can-outline">ลบ</i></a> --}}
...
<script>
    ...
    $(document).on('change', '.select-new', function(params) {
        ...
        if(values == 'report'){
            ...
            window.location='{{URL('office/durable/activity')}}'+ '/' + values + '/' + id + '/?t=distribution&pr=0';
            ...
            window.location='{{URL('office/durable/activity')}}'+ '/' + values + '/' + id;
