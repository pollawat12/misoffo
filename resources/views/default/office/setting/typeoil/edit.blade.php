...
<div class="content">
    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">ประเภทเชื้อเพลิง</li>
                        </ol>
                    </div>
                    <h4 class="page-title">แก้ไข ประเภทเชื้อเพลิง</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-box">
                    <h4 class="header-title mb-4"><i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; "> แก้ไขข้อมูล ประเภทเชื้อเพลิง</i> </h4>
                    ...
                    <form action="{{url('office/settings/data/update')}}" method="POST" name="frm-save" id="frm-save">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">ประเภทเชื้อเพลิง <code>*</code></label>
                                    <input type="text" name="input[name]" class="form-control" id="input-name" placeholder="ประเภทเชื้อเพลิง" style="height: 45px;" value="{{$info->name}}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">ร้อยละ <code>*</code></label>
                                    <input type="text" name="input[amount]" class="form-control" id="input-amount" placeholder="ค่าข้อมูล" style="height: 45px;" value="{{$info->amount}}">
                                    <small id="emailHelp" class="form-text text-muted"></small>
                                </div>
                            </div>
                            <div class="col-md-6">
...
<script>
    ...
    $(function () {
        ...
        $('#frm-save').validate({
            ...
            messages: {
                'input[name]': {
                    required: "กรุณากรอกประเภทหลักประกัน"
                }
            },
            errorElement: 'span',
