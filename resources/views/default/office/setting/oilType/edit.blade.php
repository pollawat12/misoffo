...
<div class="content">
    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">ประเภทเชื่อเพลิง</li>
                        </ol>
                    </div>
                    <h4 class="page-title">แก้ไข ประเภทเชื่อเพลิง</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-box">
                    <h4 class="header-title mb-4"><i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; "> แก้ไขข้อมูล ประเภทเชื่อเพลิง</i> </h4>
                    ...
                    <form action="{{url('office/settings/data/update')}}" method="POST" name="frm-save" id="frm-save">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">ประเภทเชื่อเพลิง <code>*</code></label>
                                    <input type="text" name="input[name]" class="form-control" id="input-name" placeholder="ประเภทเชื่อเพลิง" style="height: 45px;" value="{{$info->name}}">
                        ...
                        <div class="row">
                            <?php 
                                $statementtypes = \App\Models\DataSetting::where('group_type','oilCategory')->where('is_deleted', '0')->where('is_active','1')->get();
                            ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">ประเภทงบหลัก <code>*</code></label>
                                    <select name="input[data_value]" class="form-control" id="input-data_value" style="height: 45px;">
                                        <option value="">--เลือก--</option>
                                        <option value="0" @if(0 == $info->data_value) selected @endif>Crude</option>
                                        <option value="1" @if(1 == $info->data_value) selected @endif>ดีเซล</option>
                                        @if (!empty($statementtypes))
                                        @foreach ($statementtypes as $statementtype)
                                            <option value="{{$statementtype['id']}}" @if($statementtype['id'] == $info->data_value) selected @endif>{{$statementtype['name']}}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
