...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <?php $oilType = \App\Models\OilPriceDetail::where('oil_price_id', $id)->where('oil_category', $Category['id'])->where('is_deleted', '0')->where('is_active','1')->orderBy('oil_type', 'ASC')->get(); ?>
            <?php $no++;?>
                ...
                <div class="col-md-12">
                    <div class="card-box">
                        <h4 class="header-title mb-4">
                            <i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; "> รายละเอียด : {{$Category['name']}}</i> </h4>
                             <?php $no = 0;?>
