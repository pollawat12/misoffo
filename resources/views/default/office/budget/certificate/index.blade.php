                    ...
                    <div class="card-box table-responsive">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-2 text-right">
                                <a href="{{url('office/budget/certificate/add')}}/?t={{$t}}&pr={{$pr}}" class="btn btn-primary"><i class="mdi mdi-file-document-box-plus-outline"> เพิ่มข้อมูล</i></a>
                            </div>
                        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <?php
                                            $company = \App\Models\BudgetCertificateCompany::where('id', $item['id'])->get();
...
<script>
    ...
    $(document).on('change', '.btn-action', function(params) {
        ...
        if(values == 'view'){
            ...
            window.location='{{URL('office/budget/')}}'+ '/' + values + '/' + id + '/?t={{$t}}&pr={{$pr}}';
        } 
    });
