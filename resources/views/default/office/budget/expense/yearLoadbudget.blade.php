...
<table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <th>
                <input type="text" name="sum_total_statement"  class="form-control" placeholder="" style="height: 45px;">
            </th>
        </tr>
    </tbody>
...
<script type="text/javascript">
    $(document).on('change', '.btn-add-new', function(params) {
        ...
        $('#loadcategory'+id+''+title).load('{{URL('office/budget/expenses/year/loadcategory')}}' + '/' + values + '/' + id + '/' + title);
