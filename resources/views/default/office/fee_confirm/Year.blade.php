                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                            <h4 class="header-title">
                                <i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; "> รายละเอียดการเบิกจ่าย</i></h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <label for="exampleInputPassword1">{{$year['in_year']}}</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <h4 class="header-title" style="font-size:16px !important;">ระยะเวลางบประมาณ</h4>
                                <label for="exampleInputPassword1"> {{getDateShow($year['date_start'])}} - {{getDateShow($year['date_end'])}}</label>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-12">
                <div class="card-box table-responsive">
                    <div class="row mb-3">
                        <div class="col-6">
                            <h4 class="header-title">
                                <i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; "> รายการข้อมูล ค่าใช้จ่ายงบประมาณ</i></h4>
                            <p class="sub-header"></p>
                        </div>
                        <div class="col-6 text-right">
                            
                            <a href="{{url('office/budget/confirm/add')}}/{{$id}}/?t=1" class="btn btn-secondary"><i class="mdi mdi-file-document-box-plus-outline"> เพิ่มข้อมูล</i></a>
                        </div>
                    </div>
...
<script>
    ...
    $('select').change(function(){
        ...
        if(values == 'view'){
            ...
            window.location='{{URL('office/budget/confirm')}}'+ '/' + values + '/' + id + '/{{$id}}/?t=1';
        }
    ...
    <div class="modal-dialog modal-lg" style="max-width: 85%;">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">รายละเอียดค่าใช้จ่ายในการบริหารกองทุนพัฒนาน้ำบาดาล</h4>
            </div>
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <label for="projects_id">{{$itemModal['yearbudgets_year']}}</label>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <label for="date_report">กองทุนพัฒนาน้ำบาดาล</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <label for="year_budgets_id ">{{getDateMonthTH($itemModal['yearbudgets_start'])}} - {{getDateMonthTH($itemModal['yearbudgets_end'])}}</label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <h4 class="header-title" style="font-size:18px !important;">ผลการเบิกจ่าย</h4>
