        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-box">
                    ...
                    <form action="{{url('office/expenses/compensate/save')}}" method="POST" name="frm-save" id="frm-save" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="input[compensate_num]" class="form-control" id="compensate_num" placeholder="" style="height: 45px;"> 
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <div class="input-group">
                                                <input type="text" class="form-control datepicker-autoclose" style="height: 45px;" placeholder="วว/ดด/ปปปป"  name="input[compensate_date]" value="{{getDateFormatToInputThai(date('Y-m-d'))}}">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="compensate_oile20_liter" class="col-form-label label-step">ปริมาณ
                                                        (ลิตร)</label>
                                                    <input type="text" name="input[compensate_oile20_liter]" class="form-control" id="compensate_oile20_liter" placeholder="" style="height: 45px;">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="compensate_oile20_price" class="col-form-label label-step">จำนวนเงินขอรับชดเชย
                                                        (บาท)</label>
                                                    <input type="text" name="input[compensate_oile20_price]" class="form-control" id="compensate_oile20_price" placeholder="" style="height: 45px;">
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="compensate_oile85_liter" class="col-form-label label-step">ปริมาณ
                                                        (ลิตร)</label>
                                                    <input type="text" name="input[compensate_oile85_liter]" class="form-control" id="compensate_oile85_liter" placeholder="" style="height: 45px;">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="compensate_oile85_price" class="col-form-label label-step">จำนวนเงินขอรับชดเชย
                                                        (บาท)</label>
                                                    <input type="text" name="input[compensate_oile85_price]" class="form-control" id="compensate_oile85_price" placeholder="" style="height: 45px;">
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="compensate_oild_liter" class="col-form-label label-step">ปริมาณ
                                                        (ลิตร)</label>
                                                    <input type="text" name="input[compensate_oild_liter]" class="form-control" id="compensate_oild_liter" placeholder="" style="height: 45px;">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="compensate_oiled_price" class="col-form-label label-step">จำนวนเงินขอรับชดเชย
                                                        (บาท)</label>
                                                    <input type="text" name="input[compensate_oiled_price]" class="form-control" id="compensate_oiled_price" placeholder="" style="height: 45px;">
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="compensate_oild10_liter" class="col-form-label label-step">ปริมาณ
                                                        (ลิตร)</label>
                                                    <input type="text" name="input[compensate_oild10_liter]" class="form-control" id="compensate_oild10_liter" placeholder="" style="height: 45px;">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="compensate_oild10_price" class="col-form-label label-step">จำนวนเงินขอรับชดเชย
                                                        (บาท)</label>
                                                    <input type="text" name="input[compensate_oild10_price]" class="form-control" id="compensate_oild10_price" placeholder="" style="height: 45px;">
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="compensate_oild20_liter" class="col-form-label label-step">ปริมาณ
                                                        (ลิตร)</label>
                                                    <input type="text" name="input[compensate_oild20_liter]" class="form-control" id="compensate_oild20_liter" placeholder="" style="height: 45px;">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="compensate_oild20_price" class="col-form-label label-step">จำนวนเงินขอรับชดเชย
                                                        (บาท)</label>
                                                    <input type="text" name="input[compensate_oild20_price]" class="form-control" id="compensate_oild20_price" placeholder="" style="height: 45px;">
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="compensate_lpg_liter" class="col-form-label label-step">ปริมาณ
                                                        (ลิตร)</label>
                                                    <input type="text" name="input[compensate_lpg_liter]" class="form-control" id="compensate_lpg_liter" placeholder="" style="height: 45px;">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="compensate_lpg_price" class="col-form-label label-step">จำนวนเงินขอรับชดเชย
                                                        (บาท)</label>
                                                    <input type="text" name="input[compensate_lpg_price]" class="form-control" id="compensate_lpg_price" placeholder="" style="height: 45px;">
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
