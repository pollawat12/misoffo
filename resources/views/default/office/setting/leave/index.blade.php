...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">แสดง ประเภทการลา</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box table-responsive">
                    <div class="row mb-3">
                        <div class="col-6">
                            <h4 class="header-title">รายการข้อมูล :: ประเภทการลา</h4>
                            <p class="sub-header"></p>
                        </div>

                        <div class="col-6 text-right">
                            <a href="{{URL('office/settings/data/add')}}/?t=leave&pr=0" class="btn btn-sm btn-primary width-md waves-light"><i class="mdi mdi-database-plus"> เพิ่มข้อมูล</i></a>
                        </div>
                    </div>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    ...
                                    <select name="input_action" class="form-control" >
                                        ...
                                        <option value="decline" data-id="{{$item['id']}}">กำหนดการลา</option>
        ...
        <div id="url-redirect-back" data-url="{{url('office/settings/data/lists')}}?t=leave&pr=0"></div>
...
<script>
    ...
    $('select').change(function(){
        ...
        if(values == 'decline'){
            ...
            window.location='{{URL('office/settings/data')}}'+ '/' + values + '/' + id + '/?t=leave&pr=0';
        }
