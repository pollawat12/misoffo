...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <form action="{{url('office/budget/certificate/company/update')}}" method="POST" name="frm-save" id="frm-save">

            <div class="row">
                <div class="col-md-12">
                    <div class="card-box">
                        <h4 class="header-title mb-4"><i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; "> แก้ไขข้อมูล บริษัท/ผู้ค้า</i> </h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="input[company_num]" class="form-control" placeholder="" style="height: 45px;" value="{{$info->company_num}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <div class="input-group">
                                                <input type="text" class="form-control datepicker-autoclose"  placeholder="วว/ดด/ปปปป"  name="input[company_date]" value="@if ($info->company_date != NULL){{getDateFormatToInputThai($info->company_date)}} @endif">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="input[company_bank_num]" class="form-control" placeholder="" style="height: 45px;" value="{{$info->company_bank_num}}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="input[company_bank_name]" class="form-control" placeholder="" style="height: 45px;" value="{{$info->company_bank_name}}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="input[company_bank_account]" class="form-control" placeholder="" style="height: 45px;" value="{{$info->company_bank_account}}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="input[company_bank_branch]" class="form-control" placeholder="" style="height: 45px;" value="{{$info->company_bank_branch}}"> 
