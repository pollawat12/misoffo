...
use App\Imports\LpgCpImport;
use App\Imports\EthanolImport;
    ...
    public function importsave(Request $req)
    {
        ...
        if ($req->ajax() && $req->isMethod('post')) {
            ...
            if($pr == 1){
                ...
                $importResult = Excel::import(new LpgCpImport(0), $fileTmp);
            }elseif($pr == 12){
                $importResult = Excel::import(new EthanolImport(0), $fileTmp);
            }
