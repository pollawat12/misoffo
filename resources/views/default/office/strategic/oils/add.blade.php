    ...
    <div class="container-fluid">
        ...
        <form action="{{url('office/strategic/oil/save')}}" method="POST" name="frm-save" id="frm-save">        
            ...
            <div class="row" >
                <div class="col-md-12">
                    <div class="card-box">
                    <h4 class="header-title mb-4"><i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; "> เพิ่มข้อมูล อัตราน้ำมัน</i> </h4>
                                ...
                                <table id="datatable" class="table table-bordered" style="width: 150%">
                                    ...
                                    <thead>
                                        <tr class="bg-dark text-white">
                                            <th style="width: 1%!important;" class="align-middle">Date</th>
                                            @if (!empty($oilType))
                                            @foreach ($oilType as $Infotitle1)
                                                <th style="width: 2%">{{ $Infotitle1['name'] }}</th>
                                            @endforeach
                                            @endif
                                        </tr>
                                    </thead>
