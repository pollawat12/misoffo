...
<div class="content">
    ...
    <div class="container-fluid">
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <h4 class="header-title">
                                <i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; "> งบประมาณ</i></h4>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    {!! getLabelStatusOnOff($budget->is_deleted) !!}
                                </td>
                                <td style="width:10%">
                                    <select name="input_action" class="form-control btn-action">
                                        <option value="">เลือก</option>
                                        <option value="{{$budget->id}}" data-original-title="show" data-id="{{$budget->id}}">ตั้งงบประมาณ</option>
                                    </select>
                                </td>
                            </tr>
                            @endforeach
        ...
        <div id="div-data-url-new" data-url="{{url('office/budgets')}}"></div>       
    </div>
</div>
...
<script>
    ...
    $(document).on('change', '.btn-action', function(params) {
        ...
        window.open('{{URL('office/budgets/set')}}'+ '/' + values);
    });
