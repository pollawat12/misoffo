...
<div class="content">
    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">ยกเลิกการลา</li>
                        </ol>
                    </div>
                    <h4 class="page-title">ยกเลิกการลา</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-box">
                    <h4 class="header-title mb-4"><i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; ">ขอยกเลิกการลา</i> </h4>
                    ...
                    <form action="{{url('office/hr/leave/sub/save')}}" method="POST" name="frm-save" id="frm-save">
                        ...
                        <input type="hidden" name="cancel_id" value="{{$id}}">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="row" hidden>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="cancel_leave">ขอยกเลิกการลาเนื่องจาก</label>
                                                <textarea  name="input[cancel_leave]" class="form-control"></textarea> 
                                                <small id="cancel_leave" class="form-text text-muted"></small>
                                            </div>
                                        </div>   
                                    </div>
                                    ...
                                    <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <select name="input[division_user_id]" id="division_user_id" class="form-control" style="height: 45px;" hidden>
                                                        @if (count($groupWork_boss) > 0)
                                                        @foreach($groupWork_boss as $key => $val)
                                                        <option value="{{$val->user_id}}" @if($val->id == 30) @endif selected >{{$val->name}} </option>
                                                        @endforeach
                                                        @endif
                                                    </select>
                                                </div>
