...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-box">
                    <h4 class="header-title mb-4"><i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; "> นำเข้าข้อมูล @if($t == 1) รายรับ (IN) @elseif($t == 2) รายจ่าย (PN) @else ค้างจ่าย (RA) @endif </i> </h4>

                    <form action="{{url('office/expenses/income/import/save')}}?id={{$t}}" enctype="multipart/form-data" method="POST" name="frm-save" id="frm-save">
...
<div id="redirect-to-report-file" data-url="{{url('office/expenses/income/lists')}}/?t={{$t}}&pr={{$pr}}"></div>
@endsection
