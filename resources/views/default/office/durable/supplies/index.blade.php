        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">แสดง ข้อมูลพัสดุ/อุปกรณ์</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box table-responsive">
                    <div class="row mb-3">
                        <div class="col-6">
                            <h4 class="header-title">รายการข้อมูล :: ข้อมูลพัสดุ/อุปกรณ์</h4>
                            <p class="sub-header"></p>
                        </div>

                        <div class="col-6 text-right">
                            <a href="{{URL('office/durable/add')}}/?t=supplies&pr=0" class="btn btn-sm btn-primary width-md waves-light"><i class="mdi mdi-database-plus"> เพิ่มข้อมูล</i></a>
                        </div>
                    </div>
                    ...
                    <table id="datatable" class="table table-bordered table-striped  dt-responsive nowrap"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                {{-- <td class="align-middle">{{$item['durable_name']}}</td> --}}
                                {{-- <td class="align-middle">มีของ</td> --}}
                                <td class="align-middle">
                                    {{-- <a href="{{URL('office/durable/amount')}}/{{$item['id']}}/?t=supplies&pr=0" class="btn btn-outline-primary waves-effect width-md waves-light btn-sm"><i class="mdi mdi-file-document-box-outline">เพิ่มจำนวน</i> </a>
                                    <a href="{{URL('office/durable/edit')}}/{{$item['id']}}/?t=supplies&pr=0" class="btn btn-outline-warning waves-effect width-md waves-light btn-sm"><i class="mdi mdi-pencil-plus-outline">แก้ไข</i> </a>
                                    ...
                                    <select name="input_action" class="form-control  select-new"  data-id="{{$item['id']}}">
                                        <option value="">เลือก</option>
                                        <option value="amount">เพิ่มจำนวน</option>
...
<script>
    ...
    $(document).on('change', '.select-new', function(params) {
        ...
        if(values == 'amount'){
            ...
            window.location='{{URL('office/durable')}}'+ '/' + values + '/' + id + '/?t=supplies&pr=0';
            ...
            window.location='{{URL('office/durable/supplies')}}'+ '/' + values + '/' + id + '/?t=supplies&pr=0';
