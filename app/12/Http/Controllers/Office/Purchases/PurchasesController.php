...
class PurchasesController extends Base 
{
    ...
    public function create(Request $request)
    {
        ...
        $arr = ['purchasesstatus','purchasesmethod','purchasesmargin' , 'employees'];
    ...
    public function store(Request $request)
    {
        ...
        if ($request->ajax() && $request->isMethod('post')) {
            ...
            $numinspector = count($purchases_inspector);

            $result = Purchases::inserRow($data);

            for ($i=0; $i < $numinspector; $i++) { 
                $resultDetail = PurchasesOfficer::inserRow($purchases_inspector[$i] , $position_id[$i] , $id);
            }
    ...
    public function edit($id, Request $request)
    {
        ...
        $arr = ['id','info','purchasesstatus','purchasesmethod','purchasesmargin' , 'employees' , 'detail'];
