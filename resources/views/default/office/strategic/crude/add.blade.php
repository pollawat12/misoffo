                                ...
                                <table id="datatable" class="table table-bordered" style="width: 150%">
                                    ...
                                    <thead>
                                        <tr class="bg-dark text-white">
                                            <th rowspan="2" style="width: 1%">Date</th>
                                            @if (!empty($oilType))
                                            @foreach ($oilType as $Infotitle1)
                                                <th colspan="2" style="width: 2%">{{ $Infotitle1['name'] }}</th>
                                            @endforeach
                                            @endif
                                            <th rowspan="2" style="width: 1%">BUYING (US EX.RATE(B/$))</th>
                                            <th rowspan="2" style="width: 1%">SELLING (US EX.RATE(B/$))</th>
                                        </tr>
                                        <tr class="bg-dark text-white">
                                            @if (!empty($oilType))
                                                @foreach ($oilType as $Infotitle)
                                    ...
                                    @if (!empty($infos))
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                            <td class="align-middle">{{$item['oil_price_buying']}}</td>
                                            <td class="align-middle">{{$item['oil_price_selling']}}</td>
                                        </tr> 
                                        @endforeach
                                    @endif
                                        <tr>
                                            ...
                                            @if (!empty($oilType))
                                                @foreach ($oilType as $item)
                                                    ...
                                                    <td>
                                                        <input type="text" name="oil_max[{{$item['id']}}][]" class="form-control" placeholder="" style="height: 45px;">
                                                    </td>
                                                @endforeach
                                            @endif
                                            <td>
                                                <input type="text" name="input[oil_price_buying]" class="form-control" placeholder="" style="height: 45px;">
                                            </td>
                                            <td>
                                                <input type="text" name="input[oil_price_selling]" class="form-control" placeholder="" style="height: 45px;">
                                            </td>
                                        </tr> 
                                    </tbody>
