                    ...
                    <div class="card-box table-responsive">
                        <div class="row mb-3">
                            <div class="col-6">
                                <h4 class="header-title">
                                    <i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; "> รายการข้อมูล อัพเดทสถานะ</i></h4>
                                <p class="sub-header"></p>
                            </div>
                            <div class="col-6 text-right">
                                
                                <button class="btn btn-primary btn-action-add" type="button" data-original-title="add" data-id="0"><i class="mdi mdi-file-plus-outline"></i> เพิ่มข้อมูล</button>
                            </div>
                        </div>
                        <table id="datatable" class="table table-bordered table-striped  dt-responsive nowrap"
                            ...
                            <tr>
                                ...
                                <td class="align-middle">{{getDateShow($item['purchases_status_date'])}}</td>
                                <td class="align-middle" style="width:20%">{{$item['purchases_status_name']}}</td>
                                <td class="align-middle" style="width:20%">@if($item['purchases_status_file'] != NULL) <a href="{{url('')}}/{{$item['purchases_status_file']}}" class="btn btn-outline-warning waves-effect width-md waves-light btn-sm" target="_blank"><i class="mdi mdi-file-download-outline">ดาวน์โหลด</i> </a> @endif</td>
                                <td class="align-middle" style="width:20%">@if($item['purchases_status_to'] == 1) งบประมาณ @elseif($item['purchases_status_to'] == 2) บัญชี @elseif($item['purchases_status_to'] == 3) การเงิน @elseif($item['purchases_status_to'] == 4) ครุภัณฑ์ @endif</td>
                                <td class="align-middle" style="width:20%">{{$item['purchases_status_update']}}</td>
                                <td style="width:10%">
                                    <select name="input_action" class="form-control btn-action">
                                        ...
                                        <option value="deleted" data-original-title="del" data-id="{{$item['id']}}">ลบ</option>
                                    </select>
                                </td>
                            </tr>
                            @endforeach
