        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">แสดง การคืนครุภัณฑ์</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box table-responsive">
                    <div class="row mb-3">
                        <div class="col-6">
                            <h4 class="header-title">รายการข้อมูล :: ข้อมูลการคืนครุภัณฑ์</h4>
                            <p class="sub-header"></p>
                        </div>

                        {{-- <div class="col-6 text-right">
                            <a href="{{URL('office/durable/activity/add')}}/?t=returns&pr=0" class="btn btn-sm btn-dark width-md waves-light"><i class="mdi mdi-database-plus"> เพิ่มข้อมูล</i></a>
                        </div> --}}
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    {{-- <a href="{{URL('office/durable/activity/edit')}}/{{$item['id']}}/?t=returns&pr=0" class="btn btn-outline-warning waves-effect width-md waves-light btn-sm"><i class="mdi mdi-pencil-plus-outline">แก้ไข</i> </a>
...
<script>
    ...
    $(document).on('change', '.select-new', function(params) {
        ...
        if(values == 'report'){
            ...
            window.location='{{URL('office/durable/activity')}}'+ '/' + values + '/' + id + '/?t=returns&pr=0';
