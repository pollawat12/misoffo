        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box table-responsive">
                    <div class="row mb-3">
                        <div class="col-6">
                            <h4 class="header-title">รายการข้อมูล :: ข้อมูลซ่อมแซม</h4>
                            <p class="sub-header"></p>
                        </div>

                        <div class="col-6 text-right">
                            <a href="{{URL('office/durable/repair/add')}}/?t=repair&pr=0" class="btn btn-sm btn-primary width-md waves-light"><i class="mdi mdi-database-plus"> เพิ่มข้อมูลซ่อมแซม</i></a>
                        </div>
                    </div>
                    ...
                    <table id="datatable" class="table table-bordered table-striped  dt-responsive nowrap"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">@if ($item['is_approved'] == 0) อนุมัติการซ่อมแซม @elseif($item['is_approved'] == 1) ไม่อนุมัติการซ่อมแซม @else  @endif</td>
                                <td class="align-middle">{{number_format($item['price_sum'],2,'.',',')}}</td>
...
<script>
    ...
    $(document).on('change', '.select-new', function(params) {
        ...
        if(values == 'view'){
            ...
            window.location='{{URL('office/durable/repair/')}}'+ '/' + values + '/' + id + '/?t=repair&pr=0';

        }else if(values == 'delete'){

            window.location='{{URL('office/durable/repair/')}}'+ '/' + values + '/' + id;
