                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">ราคา เอทานอล </li>
                        </ol>
                    </div>
                    <h4 class="page-title">แสดง ราคา เอทานอล </h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box table-responsive">
                    <div class="row mb-3">
                        <div class="col-6">
                            <h4 class="header-title">รายการข้อมูล :: ราคา เอทานอล  </h4>
                    ...
                    <table id="datatable" class="table table-bordered table-striped  dt-responsive nowrap"
                        ...
                        <thead>
                            <tr class="bg-dark text-white">
                                ...
                                <th>วันที่</th>
                                <th style="width: 15%">Ethanol Ref.</th>
                                <th style="width: 15%">Ethanol Cas.</th>
                                <th style="width: 15%">Ethanol mol.</th>
                                <th style="width: 15%">Ethanol Cas./Molasses.</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">{{number_format($item->oil_price_ethanol_ref,2,'.',',')}}</td>
                                <td class="align-middle">{{number_format($item->oil_price_ethanol_cas,2,'.',',')}}</td>
                                <td class="align-middle">{{number_format($item->oil_price_ethanol_mol,2,'.',',')}}</td>
                                <td class="align-middle">{{number_format($item->oil_price_ethanol_cas_mol,2,'.',',')}}</td>
