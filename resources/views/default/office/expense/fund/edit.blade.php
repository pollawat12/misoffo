...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <form action="{{url('office/expenses/fund/update')}}" method="POST" name="frm-save" id="frm-save">
            <div class="row">
                <div class="col-md-12">
                    <div class="card-box">
                        ...
                        <h4 class="header-title mb-4">
                            ...
                            <!-- <a href="{{url('office/budgets/institution/all')}}/{{$id}}?yearid={{$yearid}}&budgetsid={{$budgetsid}}&institutionid={{$info->institution_id}}&id={{$id}}" target="_blank"><button type="button" class="btn btn-warning btn-sm"><i class="mdi mdi-file-multiple"> ดูรายการทั้งหมด</i></button></a> -->
                                ...
                                <thead>
                                    ...
                                    <?php $FundDetail = \App\Models\AssetFundDetail::where('asset_id', $id)->where('type_id', $item['id'])->where('is_deleted', '0')->where('is_active','1')->first();?>
                                    <tbody>
                            ...
                            <button type="submit" class="btn btn-primary">
                                    ...
                                    <a href="{{URL('office/expenses/fund/lists')}}"  class="btn btn-secondary"><i class=" mdi mdi-backspace-outline
                                        "> ยกเลิก</i></a>
                    </div>
        ...
        <!-- end row -->
        <div id="div-data-url" data-url="{{url('office/expenses/fund/edit')}}/{{$id}}"></div>
        <div id="url-redirect-back" data-url="{{url('office/expenses/fund/edit')}}/{{$id}}"></div>
    </div>
</div>
