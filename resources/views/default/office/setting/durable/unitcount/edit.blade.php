...
<div class="content">
    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0);">หน่วยนับ</a></li>
                            <li class="breadcrumb-item active">ข้อมูลหน่วยนับ</li>
                        </ol>
                    </div>
                    <h4 class="page-title">แก้ไข หน่วยนับ</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-box">
                    <h4 class="header-title mb-4"><i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; "> แก้ไขข้อมูล หน่วยนับ</i> </h4>
                    ...
                    <form action="{{url('office/durable/data/update')}}" method="POST" name="frm-save" id="frm-save">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">หน่วยนับ <code>*</code></label>
                                    <input type="text" name="input[name]" class="form-control" id="input-name" placeholder="หน่วยนับ" style="height: 45px;" value="{{$info->name}}">
                        ...
                        <a href="{{URL('office/durable/data/lists')}}?t=unitcount&pr=0"  class="btn btn-secondary"><i class=" mdi mdi-backspace-outline
                            "> ยกเลิก</i></a>
                    </form>
                </div>
            </div>
