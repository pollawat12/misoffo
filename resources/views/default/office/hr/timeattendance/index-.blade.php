                ...
                <div class="card-box table-responsive">
                    ...
                    <table id="datatable" class="table table-bordered table-striped  dt-responsive nowrap"
                        ...
                        <tbody>
                            ...
                            <?php $no++;?>
                            <tr>
                                <td class="align-middle">{{ $time->date_checked }}</td>
                                <td class="align-middle">{{ $time->time_checked }}</td>
                                <td class="align-middle">คุณ ฐาณัชชา ศรีรักษ์</td>
                                {{-- <td class="align-middle">
                                    {!! getBadgeDataStatus('is_deleted', $time->is_deleted) !!}
                                </td> --}}
                                <td class="align-middle">
                                    <select name="input_action" class="form-control" >
                                        <option value="">เลือก</option>
                                        <option value="delete" data-id="{{ $time->id }}">ลบ</option>
                                    </select>
                                </td>
                            </tr>
                            @endforeach
