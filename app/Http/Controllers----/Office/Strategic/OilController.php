...
class OilController extends Base
{
    ...
    public function index(Request $request)
    {
        ...
        if($pr < '100'){
            ...
            if($pr == '6' || $pr == '7'){
                ...
                $infos = OilPrice::select(DB::raw('YEAR(oil_price_date) year'))->where('oil_price_type', $pr)->where('is_deleted', '0')->where('is_active','1')->groupby('year')->orderBy('year', 'DESC')->limit(90)->get();
                ...
                $infos = OilPrice::where('oil_price_type', $pr)->where('is_deleted', '0')->where('is_active','1')->orderBy('oil_price_date', 'DESC')->limit(90)->get();
            ...
            $infos = OilPrice::where('oil_price_type', $t)->whereYear('oil_price_date', '=', $pr)->where('is_deleted', '0')->where('is_active','1')->orderBy('oil_price_date', 'DESC')->limit(90)->get();
    ...
    public function create(Request $request)
    {
        ...
        if($pr == '1'){
            ...
            $infos = OilPrice::where('oil_price_type', $pr)->where('is_deleted', '0')->where('is_active','1')->orderBy('oil_price_date', 'DESC')->limit(15)->get();
            
            $oilType = DataSetting::where('group_type', "oilType")->where('data_value', '0')->where('is_deleted', '0')->where('is_active','1')->get();

            $arr = ['t','pr','oilType' , 'infos'];
            ...
            $arr = ['t','pr','oilCategory', 'infos'];

        }elseif($pr == '3' || $pr == '11' || $pr == '4' || $pr == '12'){
