...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">นำเข้าข้อมูล</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-box">
                    <h4 class="header-title mb-4"><i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; "> นำข้อมูล</i> </h4>

                    <form action="{{url('office/durable/data/import/data')}}" enctype="multipart/form-data" method="POST" name="frm-save" id="frm-save">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="subjectid">กลุ่มราคาน้ำมัน <code>*</code></label>
                                    <select name="subjectid" id="subjectid" class="form-control" style="height: 45px;">
                                        <option value="">--เลือก--</option>
                                        @if (count($groupoil) > 0)
                                        @foreach($groupoil as $key => $val)
                        ...
                        <!-- <a href="{{URL('office/durable/data/import/lists')}}?t=durable&pr=0"  class="btn btn-secondary"><i class="mdi mdi-keyboard-backspace"> ย้อนกลับ</i></a> -->
                    </form>
                </div>
            </div>
            <!-- end col -->
...
<div id="redirect-to-report-file" data-url="{{URL('office/durable/data/import/lists')}}?t={{$t}}&pr=0"></div>
@endsection
