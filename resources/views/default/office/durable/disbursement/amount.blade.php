                                ...
                                <div class="card-box table-responsive">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-6 text-right">
                                            <a href="{{URL('office/durable/amount/add')}}/{{$id}}/?t=supplies&pr=0" class="btn btn-sm btn-dark width-md waves-light"><i class="mdi mdi-database-plus"> เพิ่มข้อมูล</i></a>
                                        </div>
                                    </div>
                                    ...
                                    <table id="datatable" class="table table-bordered table-striped dt-responsive nowrap dataTable no-footer dtr-inline" style="border-collapse: collapse; border-spacing: 0px; width: 100%;" role="grid" aria-describedby="datatable_info">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle">{{number_format($item->amount_price,2,'.',',')}}</td>
                                                <td class="align-middle">{{number_format($item->amount_price * $item->amount_num,2,'.',',')}}</td>
                                                <td class="align-middle">
                                                    <a href="{{URL('office/durable/amount/edit')}}/{{$item->id}}/?t=durable&pr=0" class="btn btn-outline-warning waves-effect width-md waves-light btn-sm"><i class="mdi mdi-pencil-plus-outline">แก้ไข</i> </a>
