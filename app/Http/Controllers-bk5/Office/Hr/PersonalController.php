...
class PersonalController extends Base 
{
    ...
    public function create($id, Request $request)
    {
        ...
        $arr = ['user','employees' , 'addresses' ,'id' , 't' , 'dutyDetail' , 'dutyContracts' , 'educations' , 'benefits' , 'welfares' , 'experiences' , 'TransferInOffice' , 'Leave' , 'evaluations' , 'Courses' , 'families'];
