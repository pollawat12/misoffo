                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">นำเข้าข้อมูลครุภัณฑ์</li>
                        </ol>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                            <h4 class="header-title">
                                <i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; "> รายการนำเข้าข้อมูลครุภัณฑ์</i></h4>
                            <p class="sub-header"></p>
                        </div>
                        <div class="col-6 text-right"><a href="{{url('office/durable/data/import/add')}}" class="btn btn-primary"><i class="mdi mdi-file-document-box-plus-outline"> นำเข้าข้อมูลครุภัณฑ์</i></a>
                        </div>
                    </div>
