...
class AssetEstimateDetail extends Model
{
    use HasFactory;

    protected $table = 'asset_estimate_detail';
    ...
    public static function inserRow($value_weight , $value_num , $value , $level_num=0 , $description=null , $typeid , $id)
    {
        $process = new self;
        $process->parent_id = 0;
        ...
        $process->value_weight = $value_weight;
        $process->value_num = $value_num;
        $process->sum_total = $value;
        $process->level_num = $level_num;
    ...
    public static function updateRow($value_weight , $value_num , $value , $level_num=0 , $description=null , $id=0)
    {
