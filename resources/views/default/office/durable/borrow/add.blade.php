...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-box">
                    <h4 class="header-title mb-4"><i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; "> เพิ่มข้อมูล เบิก / ยืม พัสดุ</i> </h4>

                    <form action="{{url('office/durable/borrow/save')}}" method="POST" name="frm-save" id="frm-save" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="value1_id" id="value1_id" value="0">
                        <!-- <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="input[borrow_number]" class="form-control" placeholder="" style="height: 45px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="input-group">
                                            <input type="text" class="form-control datepicker-autoclose"  placeholder="วว/ดด/ปปปป"  name="input[borrow_date]" style="height: 45px;">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="input[borrow_affiliate]" data-toggle="select2">
                                        ...
                                        <option value="{{$valgroups->id}}">{{$valgroups->name}}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-inline">
                                <div class="form-group ml-2">
                                    <div class="radio checkbox-primary">
                                        <input id="Check1" type="radio" name="input[borrow_status]" value="1">
                                        <label for="Check1">
                                            เบิก
                                        </label>
                                    </div>
                                ...
                                <div class="form-group ml-2">
                                    <div class="radio checkbox-primary">
                                        <input id="Check2" type="radio" name="input[borrow_status]" value="2">
                                        <label for="Check2">
                                            โอน
                                        </label>
                                    </div>
                            ...
                            <div class="form-inline mb-2">
                                <div class="form-group ml-2">
                                    <div class="radio checkbox-primary">
                                        <input id="Check3" type="radio" name="input[borrow_status]" value="3">
                                        <label for="Check3">
                                            ยืม กำหนดวันส่งคืน
                                        </label>
                                    </div>
                                ...
                                <div class="form-group ml-2">
                                    ...
                                    <!-- <div>
                                        <div class="input-group"> -->
                                            <input type="text" class="form-control datepicker-autoclose"  placeholder="วว/ดด/ปปปป" style="height: 45px;" name="input[borrow_night_date]" >
                                            <div class="input-group-append">
                                                <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                            </div>
                                    <!-- </div> -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea  name="input[borrow_night_detail]" class="form-control"></textarea>
                                ...
                                <table class="table table-bordered mb-0 input_fields_wrap">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="num[1][]" class="form-control" placeholder="" style="height: 45px;">
                                            </td>
                                            <td>
                                                <input type="text" name="add[1][]" class="form-control" placeholder="" style="height: 45px;">
                                            </td>
                                            <td>
                                                <select name="person[1][]" id="purchases_inspector" class="form-control" style="height: 45px;">
                                                    ...
                                                    <option value="{{$itememployees['id']}}">{{$itememployees['name']}}</option>
                                                    @endforeach
                                                    @endif 
                                                </select>
                                            </td>
