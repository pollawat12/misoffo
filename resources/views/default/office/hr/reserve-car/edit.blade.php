...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">แสดง แก้ไขขอมูลการลา</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-box">
                    <h4 class="header-title mb-4"><i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; ">แก้ไขขอมูลการลา</i> </h4>
                    ...
                    <form action="{{url('office/hr/leave/sub/save')}}" method="POST" name="frm-save" id="frm-save">
                        ...
                        <input type="hidden" name="leave_user_id" value="{{$info->users_id}}">
                            ...
                            <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="input[user_id]" class="form-control" style="height: 45px;" disabled>
                                                ...
                                                <div>
                                                    <div class="input-group">
                                                        <input type="text" id="total_date" class="form-control"
                                                            name="input[total_date]" value='{{$info->total_date}}'
                                        ...
                                        <div class="row" hidden>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <small id="comment" class="form-text text-muted"></small>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    @if($t == 'admin')
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="is_approved">ความเห็นผู้บังคับบัญชา<code>*</code></label>

                                                    @if($info->is_approved == '0')  {{-- ผอ.กลุ่มงานพิจารณา --}}

                                                        <select id="mySelect" name="input[is_approved]" class="form-control" style="height: 45px;">
                                                            <option value="">--เลือก--</option>
                                                            <option value="1">เห็นควรอนุญาต</option>
                                                            <option value="10">ไม่เห็นควรอนุญาต</option>
                                                        </select>


                                                    @elseif($info->is_approved == '1')    {{-- ผอ.สำนักพิจารณา --}}
                                                    
                                                        <select name="input[is_approved]" class="form-control" style="height: 45px;">
                                                            <option value="">--เลือก--</option>
                                                            <option value="3">อนุญาต</option>
                                                            <option value="9">ไม่อนุญาต</option>
                                                        </select>

                                                    @elseif($info->is_approved == '2')    {{-- ผอ.สกนช. พิจารณา --}}
                                                    ...
                                                    @elseif($info->is_approved == '4')  {{-- อนุมัติเรียบร้อย --}}
                                                    ...
                                                    @elseif($info->is_approved == '5')  {{-- HR รอยกเลิกการลา  --}}

                                                        <select name="input[is_approved]" class="form-control" style="height: 45px;">
                                                            <option value="">--เลือก--</option>
                                                            <option value="6">อนุญาต</option>
                                                            <option value="9">ไม่อนุญาต</option>
                                                        </select>
                                                    @else  

                                                        <select name="input[is_approved]" class="form-control" style="height: 45px;"> {{-- อื่นๆ --}}
                                                            <option value="">--เลือก--</option>
                                                            <option value="1">อนุญาต</option>
                                                            <option value="9">ไม่อนุญาต</option>
                                                        </select>
                        ...
                        @if($t == 'admin')
                            @if($pr == '0')
                                <a href="{{URL('office/hr/leave/all')}}"  class="btn btn-secondary"><i class=" mdi mdi-backspace-outline
                                    "> ยกเลิก</i></a>   
                            @else
                                <a href="{{URL('office/hr/leave/departments')}}/{{$pr}}/{{$de}}"  class="btn btn-secondary"><i class=" mdi mdi-backspace-outline
                                    "> ยกเลิก</i></a> 
                            @endif
                        @else
        ...
        @if($t == 'admin')
            ...
            @else
                <div id="url-redirect-back" data-url="{{url('office/hr/leave/departments')}}/{{$pr}}/{{$de}}"></div>
            @endif
        @else
