...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">เพิ่มข้อมูล จองห้องประชุม</h4>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-box">
                    <h4 class="header-title mb-4"><i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; "> เพิ่มข้อมูล จองห้องประชุม</i> </h4>

                    <form action="{{url('office/services/reserve-meeting/save')}}" method="POST" name="frm-save" id="frm-save">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="personal_nums" class="form-control" id="personal_nums" placeholder="">
                                    <small id="emailHelp" class="form-text text-muted"></small>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 ">
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <input type="checkbox" id="accessory_items" value="{{ $item->id }}" name="accessory_items[]" data-plugin="switchery" data-color="#039cfd" data-size="small"/>
                                                </div>
...
<script>
    ...
    $(function () {
        ...
        // $('#frm-save').on("submit",function(form)
        
        //     {
        //         if(!$("#accessory_items").prop("checked"))
        //         {
