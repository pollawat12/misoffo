...
class PersonalController extends Base 
{
    ...
    public function create($id, Request $request)
    {
        ...
        $benefits = UserBenefits::where('user_id',$id)->where('is_deleted', '0')->where('is_active','1')->get();
        ...
        $arr = ['user','employees' , 'addresses' ,'id' , 't' , 'dutyDetail' , 'dutyContracts' , 'educations' , 'benefits' , 'experiences' , 'TransferInOffice' , 'Leave' , 'evaluations' , 'Courses' , 'families'];
