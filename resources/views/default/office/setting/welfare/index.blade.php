...
<div class="content">
    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">ข้อมูลสวัสดิการ</li>
                        </ol>
                    </div>
                    <h4 class="page-title">แสดง ข้อมูลสวัสดิการ</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box table-responsive">
                    <div class="row mb-3">
                        <div class="col-6">
                            <h4 class="header-title">รายการข้อมูล :: ข้อมูลสวัสดิการ</h4>
                            <p class="sub-header"></p>
                        </div>

                        <div class="col-6 text-right">
                            <a href="{{URL('office/settings/data/add')}}/?t=welfare&pr=0" class="btn btn-sm btn-primary width-md waves-light"><i class="mdi mdi-database-plus"> เพิ่มข้อมูล</i></a>
                        </div>
                    </div>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    ...
                                    <select name="input_action" class="form-control" >
                                        ...
                                        <?php if($item['id'] == 790){ ?> 
                                            <option value="fund" data-id="{{$item['id']}}">ตั้งค่าเงินสมทบทางองค์กร</option>
                                        <?php } ?>
        ...
        <div id="url-redirect-back" data-url="{{url('office/settings/data/lists')}}?t=welfare&pr=0"></div>
...
<script>
    ...
    $('select').change(function(){
        ...
        if(values == 'decline'){
            ...
            window.location='{{URL('office/hr/benefits/')}}' + '/' + id + '/?t={{$t}}&pr=fund';

        }else{
            window.location='{{URL('office/settings/data')}}'+ '/' + values + '/' + id + '/?t=welfare&pr=0';
        }
