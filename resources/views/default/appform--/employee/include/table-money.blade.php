    ...
    <div class="col-md-12">
        ...
        <thead>
            <tr class="bg-dark text-white">
                <th >ลำดับ</th>
                <th width="10%">วันที่ปรับเงินเดือน</th>
                <th width="10%">คะแนนประเมิน</th>
                <th width="10%">ร้อยละที่ได้เลื่อน</th>
                <th width="10%">เงินเดือนที่ได้รับ</th>
            ...
            <tr>
                ...
                <td>
                    <select name="input_action" class="form-control btn-action">
                        ...
                        {{-- <option value="view" data-original-title="money" data-id="{{$evaluation->id}}">ดูรายละเอียด</option> --}}
...
<div id="con-close-modal-money" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg" style="max-width: 85%;">
        <form action="{{url('appform/sub/save')}}" method="POST" name="frm-money-save" id="frm-money-save" enctype="multipart/form-data">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="salary_start">เงินเดือนปัจจุบัน </label>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="salary_end"> เงินเดือนที่ได้รับ </label>
