...
Route::prefix('durable')->namespace('Durable')->group(function () {
    ...
    Route::get('print/{id}', [DurableController::class, 'print']);

    Route::get('borrow/lists', [DurableController::class, 'borrowindex']);
    Route::get('borrow/add', [DurableController::class, 'borrowcreate']);
    Route::get('borrow/edit/{id}', [DurableController::class, 'borrowedit']);
    Route::get('borrow/receive/{id}', [DurableController::class, 'borrowreceive']);
    Route::get('borrow/delete/{id}', [DurableController::class, 'borrowdestroy']);
    Route::get('borrow/report/{id}', [DurableController::class, 'borrowreport']);

    Route::post('borrow/save', [DurableController::class, 'borrowstore']);
    Route::post('borrow/update', [DurableController::class, 'borrowupdate']);
    Route::post('borrow/updatereceive', [DurableController::class, 'borrowreceiveupdate']);
