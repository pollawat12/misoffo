            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li class="mm-active">
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li><a href="{{url('dashboard/hr')}}"><i class="fas fa-angle-right"></i> บัญชี-การเงิน</a></li>
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        <li>
                            ...
                            <ul class="nav-third-level nav" aria-expanded="false">
                                <li><a href="{{ url('office/budget/expenses/all') }}">บันทึกค่าใช้จ่าย</a></li>
                                {{-- <li><a href="{{ url('office/budget/expenses/project') }}">รายการโครงการ</a></li> --}}
                                <!-- <li><a href="{{URL('office/budget/expenses/import/lists')}}/?t=expenses&pr=0">นำเข้าข้อมูลค่าใช้จ่าย</a></li> -->
                            </ul>
                        </li>
                    </ul>
