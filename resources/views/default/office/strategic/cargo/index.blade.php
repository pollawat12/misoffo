                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">LPG PRICES MOVEMENT REPORT</li>
                        </ol>
                    </div>
                    <h4 class="page-title">แสดง LPG PRICES MOVEMENT REPORT</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box table-responsive">
                    <div class="row mb-3">
                        <div class="col-6">
                            <h4 class="header-title">รายการข้อมูล :: LPG PRICES MOVEMENT REPORT </h4>
                    ...
                    <table id="datatable" class="table table-bordered table-striped  dt-responsive nowrap"
                        ...
                        <thead>
                            <tr class="bg-dark text-white">
                                ...
                                <th>วันที่</th>
                                <th style="width: 15%">PROPANE</th>
                                <th style="width: 15%">BUTANE</th>
                                <th style="width: 15%">LPG Cargo</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">LPG Cargo</td>
