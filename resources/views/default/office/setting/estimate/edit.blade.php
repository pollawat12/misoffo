        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">แก้ไข ประเภทประเมินผลความคุ้มค่าฯ</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="input[name]" class="form-control" id="input-name" placeholder="ประเภทประเมินผลความคุ้มค่าฯ" style="height: 45px;" value="{{$info->name}}">
