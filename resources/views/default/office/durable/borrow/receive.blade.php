        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-box">
                    ...
                    <form action="{{url('office/durable/borrow/updatereceive')}}" method="POST" name="frm-save" id="frm-save" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="input[borrow_number]" class="form-control" placeholder="" style="height: 45px;" value="{{$info->borrow_number}}" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="input-group">
                                            <input type="text" class="form-control datepicker-autoclose"  placeholder="วว/ดด/ปปปป"  name="input[borrow_date]" style="height: 45px;" value="@if ($info->borrow_date != NULL){{getDateFormatToInputThai($info->borrow_date)}} @endif" disabled>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="input[borrow_affiliate]" data-toggle="select2" disabled>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="input[borrow_institution]" data-toggle="select2" disabled>
                                        <option value="">--เลือก--</option>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-inline">
                                <div class="form-group ml-2">
                                    <div class="radio checkbox-primary">
                                        <input id="Check1" type="radio" name="input[borrow_status]" value="1" @if($info->borrow_status == 1) checked @endif disabled>
                                        <label for="Check1">
                                            เบิก
                                        </label>
                                    </div>
                                ...
                                <div class="form-group ml-2">
                                    <div class="radio checkbox-primary">
                                        <input id="Check2" type="radio" name="input[borrow_status]" value="2" @if($info->borrow_status == 2) checked @endif disabled>
                                        <label for="Check2">
                                            โอน
                                        </label>
                                    </div>
                            ...
                            <div class="form-inline mb-2">
                                <div class="form-group ml-2">
                                    <div class="radio checkbox-primary">
                                        <input id="Check3" type="radio" name="input[borrow_status]" value="3" @if($info->borrow_status == 3) checked @endif disabled>
                                        <label for="Check3">
                                            ยืม กำหนดวันส่งคืน
                                        </label>
                                    </div>
                                ...
                                <div class="form-group ml-2">
                                    ...
                                    <!-- <div>
                                        <div class="input-group"> -->
                                            <input type="text" class="form-control datepicker-autoclose"  placeholder="วว/ดด/ปปปป" style="height: 45px;" disabled name="input[borrow_night_date]" value="@if ($info->durable_invoice_date != NULL){{getDateFormatToInputThai($info->borrow_night_date)}} @endif">
                                            <div class="input-group-append">
                                                <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                            </div>
                                    <!-- </div> -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea  name="input[borrow_night_detail]" class="form-control" disabled>{{$info->borrow_night_detail}}</textarea>
                        ...
                        <div class="col-lg-12">
                            <div class="title-aad-name mt-2 mb-2">
                                <div class="label-step mt-2 mb-2">พัสดุ</div>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered mb-0 input_fields_wrap">
                                    <thead class="thead-dark">
                                        <tr>
                                            <th class="text-center text-white" style="width: 5%;">เลือก</th>
                                                    ...
                                                    <tr>
                                                        <td class="text-center">
                                                            <!-- <div class="checkbox checkbox-primary"> -->
                                                                <input type="checkbox" name="checkbox_id[1][<?php echo $detail['id'];?>]" value="1">
                                                                <input type="checkbox" name="value_id[1][<?php echo $detail['id'];?>]" value="{{$detail['durable_id']}}">
                                                            <!-- </div> -->
                                                        </td>
                                                        <td>
                                                            <select name="valuetest_id[1][<?php echo $detail['id'];?>]" id="purchases_inspector" class="form-control" style="height: 45px;" disabled>
                                                                <option value="">--เลือก--</option>
                                                                @if (count($item) > 0)
                                                        ...
                                                        <td>
                                                            <input type="text" name="num[1][<?php echo $detail['id'];?>]" class="form-control" disabled placeholder="" style="height: 45px;" value="{{$detail['durable_num']}}">
                                                        </td>
                                                        <td>
                                                            <input type="text" name="add[1][<?php echo $detail['id'];?>]" class="form-control" disabled placeholder="" style="height: 45px;" value="{{$detail['durable_location']}}">
                                                        </td>
                                                        <td>
                                                            <select name="person[1][<?php echo $detail['id'];?>]" id="purchases_inspector" disabled class="form-control" style="height: 45px;">
                                                                <option value="">--เลือก--</option>
                                                                @if (!empty($employees))
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-inline">
                                <div class="form-group ml-2">
                                    <div class="radio checkbox-primary">
                                        <input id="CheckD1" type="radio" name="input[borrow_approve_status]" value="1" >
                                        <label for="CheckD1">
                                            ไม่อนุมัติ
                                        </label>
                                    </div>
                            ...
                            <div class="form-inline mb-2">
                                <div class="form-group ml-2">
                                    <div class="radio checkbox-primary">
                                        <input id="CheckD3" type="radio" name="input[borrow_approve_status]" value="2">
                                        <label for="CheckD3">
                                            อนุมัติ ผู้มารับพัสดุ
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group ml-2">
                                    ...
                                    <!-- <div>
                                        <div class="input-group"> -->
                                            <select name="input[borrow_receive_name]" id="borrow_receive_name" class="form-control" style="height: 45px;">
                                                <option value="">--เลือก--</option>
                                                @if (!empty($employees))
                                                @foreach ($employees as $itememployee)
                                                <option value="{{$itememployee['id']}}">{{$itememployee['name']}}</option>
                                                @endforeach
                                                @endif 
                                            </select>
                                    <!-- </div> -->
                                ...
                                <div class="form-group ml-2">
                                    <label class="sr-only" for="exampleInputEmail21">วันที่รับ</label>
                                    <!-- <div>
                                        <div class="input-group"> -->
                                            <input type="text" class="form-control datepicker-autoclose"  placeholder="วว/ดด/ปปปป" style="height: 45px;" disabled name="input[borrow_receive_date]" >
                                            <div class="input-group-append">
                                                <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                            </div>
                                    <!-- </div> -->
