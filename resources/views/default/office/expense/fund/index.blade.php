                ...
                <div class="card-box table-responsive">
                    <div class="row mb-3">
                        ...
                        <div class="col-6 text-right">
                            <a href="{{url('office/expenses/fund/add')}}" class="btn btn-secondary"><i class="mdi mdi-file-document-box-plus-outline"> เพิ่มข้อมูล</i></a>
                        </div>
                    </div>
...
<script>
    ...
    $(document).on('change', 'select', function(params) {
        ...
        if(values == 'edit'){
            window.location='{{URL('office/expenses/fund')}}'+ '/' + values + '/' + id;
        }else if(values == 'imports'){
            window.location='{{URL('office/expenses/fund/imports/lists/')}}'+ '/' + id;
        }else{
            window.location='{{URL('office/expenses/fund')}}'+ '/' + values + '/' + id;
        }  
    });
