                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">S'PORE PRODUCT PRICE MOVEMENT REPORT</li>
                        </ol>
                    </div>
                    <h4 class="page-title">แสดง S'PORE PRODUCT PRICE MOVEMENT REPORT</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box table-responsive">
                    <div class="row mb-3">
                        <div class="col-6">
                            <h4 class="header-title">รายการข้อมูล :: S'PORE PRODUCT PRICE MOVEMENT REPORT </h4>
                    ...
                    <table id="datatable" class="table table-bordered table-striped  dt-responsive nowrap"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">Inside Crude</td>
