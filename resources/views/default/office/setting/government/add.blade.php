...
<div class="content">
    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">ระดับสำหรับข้าราชการ</li>
                        </ol>
                    </div>
                    <h4 class="page-title">แสดง ระดับสำหรับข้าราชการ</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-box">
                    <h4 class="header-title mb-4"><i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; "> เพิ่มข้อมูล ระดับสำหรับข้าราชการ</i> </h4>
                    ...
                    <form action="{{url('office/settings/data/save')}}" method="POST" name="frm-save" id="frm-save">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">ระดับสำหรับข้าราชการ <code>*</code></label>
                                    <input type="text" name="input[name]" class="form-control" id="input-name" placeholder="ระดับสำหรับข้าราชการ" style="height: 45px;">
                        ...
                        <a href="{{URL('office/settings/data/lists')}}?t=government&pr=0"  class="btn btn-secondary"><i class=" mdi mdi-backspace-outline
                            "> ยกเลิก</i></a>
                    </form>
                </div>
            </div>
...
<script>
    ...
    $(function () {
        ...
        $('#frm-save').validate({
            ...
            messages: {
                'input[name]': {
                    required: "กรุณากรอกระดับสำหรับข้าราชการ"
                }
            },
            errorElement: 'span',
