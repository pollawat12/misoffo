                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">ราคา ไบโอดีเซล </li>
                        </ol>
                    </div>
                    <h4 class="page-title">แสดง ราคา ไบโอดีเซล </h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box table-responsive">
                    <div class="row mb-3">
                        <div class="col-6">
                            <h4 class="header-title">รายการข้อมูล :: ราคา ไบโอดีเซล  </h4>
                    ...
                    <table id="datatable" class="table table-bordered table-striped  dt-responsive nowrap"
                        ...
                        <thead>
                            <tr class="bg-dark text-white">
                                ...
                                <th>วันที่</th>
                                <th style="width: 15%">ราคา ไบโอดีเซล</th>
                                <th style="width: 15%">ราคา เพนนินซูลา</th>
                                <th style="width: 15%">ราคา ซาบาห์</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">{{number_format($item->oil_price_b100,2,'.',',')}}</td>
                                <td class="align-middle">{{number_format($item->oil_price_peninsula,2,'.',',')}}</td>
                                <td class="align-middle">{{number_format($item->oil_price_sabah,2,'.',',')}}</td>
