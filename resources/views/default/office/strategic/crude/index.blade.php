        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box table-responsive">
                    <div class="row mb-3">
                        <div class="col-6">
                            <h4 class="header-title">รายการข้อมูล :: PLATT'S CRUDE OIL PRICES </h4>
                    ...
                    <table id="datatable" class="table table-bordered table-striped  dt-responsive nowrap"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">Crude</td>
                                <td class="align-middle">{{getDateShow($item->oil_price_date)}}</td>
                                <td class="align-middle">{{number_format($item->oil_price_buying,2,'.',',')}}</td>
                                <td class="align-middle">{{number_format($item->oil_price_selling,2,'.',',')}}</td>
