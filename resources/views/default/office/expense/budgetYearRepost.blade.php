    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">รายงานงบประมาณ</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <form action="{{url('office/budget/expenses/year/save')}}" method="POST" name="frm-save" id="frm-save">
            <div class="row">
                <div class="col-md-12">
                    <div class="card-box">
                        <h4 class="header-title mb-4"><i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; ">แผนการใช้งบประมาณ</i> </h4>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="header-title font-16">ปีงบประมาณ</label>
                                        <select name="year_id_n" id="year_id_n" class="form-control">
                                    ...
                                    <table id="datatable" class="table table-bordered">
                                        ...
                                        <thead>
                                            <tr class="bg-dark text-white">
                                                <th style="width: 3%" rowspan="2" class="align-middle text-center">ลำดับ</th>
                                                <th style="width: 15%" rowspan="2" class="align-middle text-center">รายงาน</th>
                                                <th style="width: 20%" colspan="4" class="align-middle text-center">ไตรมาส 1 ปีงบประมาณ {{$valyear->in_year}}</th>
                                                <th style="width: 20%" colspan="4" class="align-middle text-center">ไตรมาส 2 ปีงบประมาณ {{$valyear->in_year}}</th>
                                                <th style="width: 20%" colspan="4" class="align-middle text-center">ไตรมาส 3 ปีงบประมาณ {{$valyear->in_year}}</th>
                                                <th style="width: 20%" colspan="4" class="align-middle text-center">ไตรมาส 4 ปีงบประมาณ {{$valyear->in_year}}</th>
                                                <th style="width: 15%" rowspan="2" class="align-middle text-center">รวมรายจ่าย ปีงบประมาณ {{$valyear->in_year}}</th>
                                                <th style="width: 15%" rowspan="2" class="align-middle text-center">งบประมาณที่ได้รับ </th>
                                            </tr>
                                            <tr>
                                                <th style="width: 5%" class="align-middle text-center">ต.ค. {{$valyear->in_year - 1}}</th>
                                                <th style="width: 5%" class="align-middle text-center">พ.ย. {{$valyear->in_year - 1}}</th>
                                                <th style="width: 5%" class="align-middle text-center">ธ.ค. {{$valyear->in_year - 1}}</th>
                                                <th style="width: 5%" class="align-middle text-center">รวมไตรมาส</th>
                                                <th style="width: 5%" class="align-middle text-center">ม.ค. {{$valyear->in_year}}</th>
                                                <th style="width: 5%" class="align-middle text-center">ก.พ. {{$valyear->in_year}}</th>
                                                <th style="width: 5%" class="align-middle text-center">มี.ค {{$valyear->in_year}}</th>
                                                <th style="width: 5%" class="align-middle text-center">รวมไตรมาส</th>
                                                <th style="width: 5%" class="align-middle text-center">เม.ย. {{$valyear->in_year}}</th>
                                                <th style="width: 5%" class="align-middle text-center">พ.ค. {{$valyear->in_year}}</th>
                                                <th style="width: 5%" class="align-middle text-center">มิ.ย. {{$valyear->in_year}}</th>
                                                <th style="width: 5%" class="align-middle text-center">รวมไตรมาส</th>
                                                <th style="width: 5%" class="align-middle text-center">ก.ค. {{$valyear->in_year}}</th>
                                                <th style="width: 5%" class="align-middle text-center">ส.ค. {{$valyear->in_year}}</th>
                                                <th style="width: 5%" class="align-middle text-center">ก.ย. {{$valyear->in_year}}</th>
                                                <th style="width: 5%" class="align-middle text-center">รวมไตรมาส</th>
                                            </tr>
                                        </thead>
                                            <tbody>
