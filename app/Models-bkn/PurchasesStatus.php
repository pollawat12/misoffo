...
class PurchasesStatus extends Model
{
    ...
    public static function insertRow($data, $returnId=false)
    {
        ...
        $process->purchases_status_name = isset($data['purchases_status_name'])  ? trim($data['purchases_status_name']) : '';
        $process->purchases_status_pay = isset($data['purchases_status_pay'])  ? trim($data['purchases_status_pay']) : 0.00;
