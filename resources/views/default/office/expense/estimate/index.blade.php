                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                            <h4 class="header-title">
                                <i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; "> รายการข้อมูล ประเภทประเมินผลความคุ้มค่าฯ</i></h4>
                            <p class="sub-header"></p>
                        </div>
                        <div class="col-6 text-right">
                            <a href="{{url('office/expenses/estimate/add')}}" class="btn btn-secondary"><i class="mdi mdi-file-document-box-plus-outline"> เพิ่มข้อมูล</i></a>
                        </div>
                    </div>
...
<script>
    ...
    $(document).on('change', 'select', function(params) {
        ...
        if(values == 'edit'){
            window.location='{{URL('office/expenses/estimate')}}'+ '/' + values + '/' + id;
        }else if(values == 'imports'){
            window.location='{{URL('office/expenses/estimate/imports/lists/')}}'+ '/' + id;
        }else{
            window.location='{{URL('office/expenses/estimate')}}'+ '/' + values + '/' + id;
        }  
    });
