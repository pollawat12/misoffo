        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">แสดง จองรถยนต์ส่วนกลาง</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                                    ...
                                    <table class="table table-bordered mb-0" id="datatable">
                                        <thead class="thead-dark">
                                            <tr>
                                                ...
                                                <th class="text-white text-center custom-table" style="width: 15%;">วันที่ใช้งาน</th>
                                                <th class="text-center text-white custom-table">ชื่อผู้จอง</th>
                                                <th class="text-center text-white custom-table">ทะเบียนรถ</th>
                                                <th class="text-center text-white custom-table" style="width: 15%;">สถานะการอนุมัติ</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="custom-table text-center">1 พ.ค. 2565 10:00 น.</td>
                                                <td class="text-center custom-table">นายสมพงษ์ รักเกียรติ</td>
                                                <td class="text-center custom-table">8 กฬ 6509</td>
                                                <td class="text-center custom-table">
                                                    {!! getBadgeDataStatus('status_booking_car', 'no_approved') !!}
                                                </td>
                                                <td class="text-center custom-table">
