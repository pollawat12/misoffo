...
<div class="content">
    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">ขอหนังสือรับรอง</li>
                        </ol>
                    </div>
                    <h4 class="page-title">แสดง ขอหนังสือรับรอง</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box table-responsive">
                    <div class="row mb-3">
                        <div class="col-6">
                            <h4 class="header-title">รายการข้อมูล :: ขอหนังสือรับรอง</h4>
                            <p class="sub-header"></p>
                        </div>

                        <div class="col-6 text-right">
                            <a href="{{URL('office/settings/data/add')}}/?t=credentials&pr=0" class="btn btn-sm btn-primary width-md waves-light"><i class="mdi mdi-database-plus"> เพิ่มข้อมูล</i></a>
                        </div>
                    </div>
                    ...
                    <table id="datatable" class="table table-bordered table-striped  dt-responsive nowrap"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    {{-- <a href="{{URL('office/settings/data/edit')}}/{{$item->id}}/?t=credentials&pr=0" class="btn btn-outline-warning waves-effect width-md waves-light btn-sm"><i class="mdi mdi-pencil-plus-outline">แก้ไข</i> </a>
        ...
        <div id="div-data-url" data-url="{{url('office/hr/leave')}}"></div>
        <div id="url-redirect-back" data-url="{{url('office/settings/data/lists')}}?t=credentials&pr=0"></div>
...
<div id="con-close-modal-decline" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg" style="max-width: 50%;">
        <form action="{{url('office/hr/leave/decline/save')}}" method="POST" name="frm-decline-save" id="frm-decline-save" enctype="multipart/form-data">
...
<script>
    ...
    $('select').change(function(){
        ...
        if(values == 'decline'){
            ...
            window.location='{{URL('office/settings/data')}}'+ '/' + values + '/' + id + '/?t=credentials&pr=0';
        }
