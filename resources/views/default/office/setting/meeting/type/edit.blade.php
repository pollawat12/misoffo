        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">แก้ไข ประเภทการประชุม</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-box">
                    ...
                    <form action="{{url('office/settings/meeting_type/update')}}" method="POST" name="frm-save" id="frm-save">
                        <input type="hidden" name="edit_id" value="{{$id}}">
                        <input type="hidden" name="group_type" value="meeting_type">
                        <div class="row">
                            <div class="col-md-9">
                                <div class="form-group">
                                    <label for="name">ประเภทการประชุม <code>*</code></label>
                        ...
                        <a href="{{URL('office/settings/meeting_type')}}"  class="btn btn-secondary"><i class="fas fa-arrow-left"></i> ยกเลิก</i></a>
                    </form>
                </div>
            </div>
            <!-- end col -->
...
<div id="div-redirect-back" data-url="{{ URL('office/settings/meeting_type') }}"></div>
@endsection
