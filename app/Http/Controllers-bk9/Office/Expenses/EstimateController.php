                ...
                foreach ($institution as $item){
                    ...
                    if(isset($data['value_weight'.$item['id']]) || isset($data['value_num'.$item['id']]) || isset($data['sum_total'.$item['id']])){
                        ...
                        if(isset($FundDetail)){
                            ...
                            $result = AssetEstimateDetail::updateRow($data['value_weight'.$item['id']] , $data['value_num'.$item['id']] , $data['sum_total'.$item['id']] , $FundDetail->id);

                        }else{

                            $result = AssetEstimateDetail::inserRow($data['value_weight'.$item['id']] , $data['value_num'.$item['id']] , $data['sum_total'.$item['id']] , $item['id'] , $id);
                        }
