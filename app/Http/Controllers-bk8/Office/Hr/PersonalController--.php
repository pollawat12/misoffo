...
class PersonalController extends Base 
{
    ...
    public function substore(Request $request)
    {
        ...
        if ($request->ajax() && $request->isMethod('post')) {
            ...
            $duty = UserDutyDetail::where('users_id',$authInfo->users_id)->where('is_deleted', '0')->where('is_active','1')->skip(0)->take(1)->get();
            ...
            if($action == 'general'){
                ...
                if ($result) {
                    ...
                    $activity = [
                        'subject' => 'อัพเดทข้อมูลทั่วไป::คุณ '.$authInfo->firstname.' '.$authInfo->lastname,
                        'department_id' => (int) 0,
                        'group_id' => (int) 0,
                ...
                if ($result) {
                    ...
                    $activity = [
                        'subject' => 'อัพเดทข้อมูลที่อยู่::คุณ '.$authInfo->firstname.' '.$authInfo->lastname,
                        'department_id' => (int) 0,
                        'group_id' => (int) 0,
                        'position_id' => (int) $position
                    ];
                ...
                if ($startProject > $endProject) {
                    ...
                    if ($result) {
                        ...
                        $activity = [
                            'subject' => 'อัพเดทข้อมูลการทำงาน::คุณ '.$authInfo->firstname.' '.$authInfo->lastname,
                            'department_id' => (int) 0,
                            'group_id' => (int) 0,
                            'position_id' => (int) $position
                        ];
                ...
                if ($startProject > $endProject) {
                    ...
                    if ($result) {
                        ...
                        $activity = [
                            'subject' => 'อัพเดทข้อมูลการต่อสัญญา::คุณ '.$authInfo->firstname.' '.$authInfo->lastname,
                            'department_id' => (int) 0,
                            'group_id' => (int) 0,
                            'position_id' => (int) $position
                        ];
                ...
                if ($result) {
                    $activity = [
                        'subject' => 'อัพเดทข้อมูลครอบครัว::คุณ '.$authInfo->firstname.' '.$authInfo->lastname,
                        'department_id' => (int) 0,
                        'group_id' => (int) 0,
                        'position_id' => (int) $position
                    ];
                ...
                if ($result) {
                    ...
                    $activity = [
                        'subject' => 'อัพเดทข้อมูลการศึกษา::คุณ '.$authInfo->firstname.' '.$authInfo->lastname,
                        'department_id' => (int) 0,
                        'group_id' => (int) 0,
                        'position_id' => (int) $position
                    ];
                ...
                if ($startProject > $endProject) {
                    ...
                    if ($result) {
                        ...
                        $activity = [
                            'subject' => 'อัพเดทข้อมูลประสบการณ์ทำงาน::คุณ '.$authInfo->firstname.' '.$authInfo->lastname,
                            'department_id' => (int) 0,
                            'group_id' => (int) 0,
                            'position_id' => (int) $position
                        ];
                ...
                if ($startProject > $endProject) {
                    ...
                    if ($result) {
                        ...
                        $activity = [
                            'subject' => 'อัพเดทข้อมูลประวัติการช่วยปฏิบัติราชการ ::คุณ '.$authInfo->firstname.' '.$authInfo->lastname,
                            'department_id' => (int) 0,
                            'group_id' => (int) 0,
                            'position_id' => (int) $position
                        ];
                ...
                if ($startProject > $endProject) {
                    ...
                    if ($result) {
                        ...
                        $activity = [
                            'subject' => 'อัพเดทข้อมูลการปรับเงินเดือน ::คุณ '.$authInfo->firstname.' '.$authInfo->lastname,
                            'department_id' => (int) 0,
                            'group_id' => (int) 0,
                            'position_id' => (int) $position
                        ];
