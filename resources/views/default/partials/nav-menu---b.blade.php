    ...
    <div class="slimscroll-menu">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li class="mm-active">
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li>
                            ...
                            <ul class="nav-second-level" aria-expanded="false">
                                <li><a href="{{URL('dashboard/strategy')}}/?t=reports&pr=1"><i
                                            class="fas fa-angle-right mr-1"></i>ราคาน้ำมัน</a></li>
                                <li> <a href="{{URL('dashboard/strategy')}}/?t=reports&pr=2"><i
                                            class="fas fa-angle-right mr-1"></i>สภาพคล่อง</a></li>
                                <li><a href="{{URL('dashboard/strategy')}}/?t=reports&pr=3"><i
                                            class="fas fa-angle-right mr-1"></i>สถานะการด้านน้ำมัน</a></li>
                                <!-- <li> <a href="{{URL('dashboard/strategy')}}/?t=reports&pr=4"><i
                                            class="fas fa-angle-right mr-1"></i>สถานะการด้าน LPG</a></li>
                                <li><a href="{{URL('dashboard/strategy')}}/?t=reports&pr=5"><i
                                            class="fas fa-angle-right mr-1"></i>โครงสร้างราคา</a></li> -->
                            </ul>
                        </li>
                ...
                <?php
                    $RoleOil = \App\Models\ModulePermission::where('module_functions_id', '49')->where('roles_id', $nav_role_id)->where('is_deleted', '0')->where('is_active','1')->get();
                    if(count($RoleOil) > 0):
                ?>    
                <li>
                    <a href="javascript: void(0);">
                    ...
                    <ul class="nav-second-level nav" aria-expanded="false">
                        <?php
                            $RoleOil1 = \App\Models\ModulePermission::where('module_functions_id', '50')->where('roles_id', $nav_role_id)->where('is_deleted', '0')->where('is_active','1')->get();
                            if(count($RoleOil1) > 0):
                        ?> 
                        <li>
                            <a href="javascript: void(0);" aria-expanded="false">น้ำมัน
                                <span class="menu-arrow"></span>
                            </a>
                            <ul class="nav-third-level nav" aria-expanded="false">
                                <li>
                                    <a href="javascript: void(0);" aria-expanded="false">ราคาปิโตเลียม
                                        <span class="menu-arrow"></span>
                                    </a>
                                    <ul class="nav-third-level nav" aria-expanded="false">
                                        <li>
                                            <a href="{{URL('office/strategic/oil/lists')}}/?t=crude&pr=1"><i class="fas fa-angle-right mr-1"></i>Crude</a>
                                        </li>
                                        <li>
                                            <a href="{{URL('office/strategic/oil/lists')}}/?t=inside&pr=2"><i class="fas fa-angle-right mr-1"></i>Inside Crude</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="{{URL('office/strategic/oil/lists')}}/?t=oilContent&pr=5"><i class="fas fa-angle-right mr-1"></i>ปริมาณการใช้น้ำมันเชื้อเพลิง</a>
                                </li>
                                <li>
                                    <a href="{{URL('office/strategic/oil/lists')}}/?t=oils&pr=8"><i class="fas fa-angle-right mr-1"></i>อัตราน้ำมัน</a>
                                </li>
                                <!-- <li>
                                    <a href="{{URL('office/strategic/oil/lists')}}/?t=oilbuy&pr=11"><i class="fas fa-angle-right mr-1"></i>ราคาขายปลีกน้ำมันเชื้อเพลิง</a>
                                </li> -->
                                <li>
                                    <a href="javascript: void(0);" aria-expanded="false">นำเข้าข้อมูล 
                                        <span class="menu-arrow"></span>
                                    ...
                                    <ul class="nav-third-level nav" aria-expanded="false">
                                        <li><a href="{{URL('office/strategic/oil/import/lists')}}/?t=crude&pr=1"><i class="fas fa-angle-right mr-1"></i> Crude</a></li>
                                        <li><a href="{{URL('office/strategic/oil/import/lists')}}/?t=inside&pr=2"><i class="fas fa-angle-right mr-1"></i>  Inside Crude</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        ...
                        <?php
                            $RoleOil2 = \App\Models\ModulePermission::where('module_functions_id', '51')->where('roles_id', $nav_role_id)->where('is_deleted', '0')->where('is_active','1')->get();
                            if(count($RoleOil2) > 0):
                        ?> 
                        <li>
                            <a href="javascript: void(0);" aria-expanded="false">ก๊าซ LPG
                                <span class="menu-arrow"></span>
                            </a>
                            <ul class="nav-third-level nav" aria-expanded="false">
                                <li>
                                    ...
                                    <ul class="nav-third-level nav" aria-expanded="false">
                                        <li>
                                            <a href="{{URL('office/strategic/oil/lists')}}/?t=cargo&pr=3"><i class="fas fa-angle-right mr-1"></i> Cargo</a>
                                        </li>
                                        <li>
                                            <a href="{{URL('office/strategic/oil/lists')}}/?t=cp&pr=11"><i class="fas fa-angle-right mr-1"></i> Cp</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="javascript: void(0);" aria-expanded="false">ปริมาณการจัดหาก๊าซ 
                                        <span class="menu-arrow"></span>
                                    </a>
                                    <ul class="nav-third-level nav" aria-expanded="false">
                                        <li><a href="{{URL('office/strategic/oil/lists')}}/?t=situation&pr=6"><i class="fas fa-angle-right mr-1"></i> สถานการณ์ </a></li>
                                        <li><a href="{{URL('office/strategic/oil/lists')}}/?t=supply&pr=7"><i class="fas fa-angle-right mr-1"></i>  จัดหา</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="{{URL('office/strategic/oil/lists')}}/?t=lpg&pr=9"><i class="fas fa-angle-right mr-1"></i>อัตราก๊าซ </a>
                                </li>
                                <li>
                                    <a href="{{URL('office/strategic/oil/lists')}}/?t=lpgRetail&pr=10"><i class="fas fa-angle-right mr-1"></i>ราคาขายปลีกก๊าซ </a>
                                </li>
                                <li>
                                    <a href="javascript: void(0);" aria-expanded="false">นำเข้าข้อมูล 
                                        <span class="menu-arrow"></span>
                                    ...
                                    <ul class="nav-third-level nav" aria-expanded="false">
                                        <li><a href="{{URL('office/strategic/oil/import/lists')}}/?t=cargo&pr=3"><i class="fas fa-angle-right mr-1"></i>  Cargo</a></li>
                                        <li><a href="{{URL('office/strategic/oil/import/lists')}}/?t=cp&pr=11"><i class="fas fa-angle-right mr-1"></i>  CP</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        ...
                        <?php
                            $RoleOil3 = \App\Models\ModulePermission::where('module_functions_id', '52')->where('roles_id', $nav_role_id)->where('is_deleted', '0')->where('is_active','1')->get();
                            if(count($RoleOil3) > 0):
                        ?> 
                        <li>
                            <a href="javascript: void(0);" aria-expanded="false">ไบโอดีเซล
                                <span class="menu-arrow"></span>
                            </a>
                            <ul class="nav-third-level nav" aria-expanded="false">
                                <li>
                                    <li><a href="{{URL('office/strategic/oil/lists')}}/?t=exchange&pr=4"><i class="fas fa-angle-right mr-1"></i> B100</a></li>
                                    <li><a href="{{URL('office/strategic/oil/lists')}}/?t=ethanol&pr=12"><i class="fas fa-angle-right mr-1"></i> Ethanol</a></li>
                                    <!-- <li><a href="{{URL('office/strategic/oil/import/lists')}}/?t=exchange&pr=4"><i class="fas fa-angle-right mr-1"></i> นำเข้าข้อมูล</a></li> -->
                                    <li>
                                        <a href="javascript: void(0);" aria-expanded="false">นำเข้าข้อมูล 
                                            <span class="menu-arrow"></span>
                                        </a>
                                        <ul class="nav-third-level nav" aria-expanded="false">
                                            <li><a href="{{URL('office/strategic/oil/import/lists')}}/?t=exchange&pr=4"><i class="fas fa-angle-right mr-1"></i>  B100</a></li>
                                            <li><a href="{{URL('office/strategic/oil/import/lists')}}/?t=ethanol&pr=12"><i class="fas fa-angle-right mr-1"></i>  Ethanol</a></li>
                                        </ul>
                                    </li>
                                </li>
                            </ul>
                        ...
                        <?php
                            $RoleOil4 = \App\Models\ModulePermission::where('module_functions_id', '53')->where('roles_id', $nav_role_id)->where('is_deleted', '0')->where('is_active','1')->get();
                            if(count($RoleOil4) > 0):
                        ?> 
                        <li>
                            <a href="javascript: void(0);" aria-expanded="false">ตั้งค่า 
                            ...
                            <ul class="nav-third-level nav" aria-expanded="false">
                                <li><a href="{{URL('office/settings/data/lists')}}/?t=oilCategory&pr=0"><i class="fas fa-angle-right mr-1"></i> หมวดหมู่</a></li>
                                <li><a href="{{URL('office/settings/data/lists')}}/?t=oilType&pr=0"><i class="fas fa-angle-right mr-1"></i>  ประเภทเชื่อเพลิง</a></li>
                                <li><a href="{{URL('office/settings/data/lists')}}/?t=oilGroup&pr=0"><i class="fas fa-angle-right mr-1"></i>  กลุ่มน้ำมัน</a></li>
                                <li><a href="{{URL('office/settings/data/lists')}}/?t=domestic&pr=0"><i class="fas fa-angle-right mr-1"></i>  การจัดหาภายในประเทศ</a></li>
                                <li><a href="{{URL('office/settings/data/lists')}}/?t=portage&pr=0"><i class="fas fa-angle-right mr-1"></i>  การนำเข้า/ส่งออก</a></li>
                                <li><a href="{{URL('office/settings/data/lists')}}/?t=business&pr=0"><i class="fas fa-angle-right mr-1"></i>  ประเภทธุรกิจ</a></li>
                                <li><a href="{{URL('office/settings/data/lists')}}/?t=situation&pr=0"><i class="fas fa-angle-right mr-1"></i>  ประเภทสถานการณ์</a></li>
                                <li><a href="{{URL('office/settings/data/lists')}}/?t=oils&pr=0"><i class="fas fa-angle-right mr-1"></i>  น้ำมัน</a></li>
                                <li><a href="{{URL('office/settings/data/lists')}}/?t=lpg&pr=0"><i class="fas fa-angle-right mr-1"></i>  LPG</a></li>
                                <li><a href="{{URL('office/settings/data/lists')}}/?t=lpgRetail&pr=0"><i class="fas fa-angle-right mr-1"></i>  LPG retail</a></li>
                                <li><a href="{{URL('office/strategic/oil/settings/lists')}}/?t=exchange&pr=0"><i class="fas fa-angle-right mr-1"></i> Exchange Rate</a></li>
                                <li><a href="{{URL('office/strategic/oil/settings/lists')}}/?t=oilprice&pr=0"><i class="fas fa-angle-right mr-1"></i> อัตราราคาน้ำมัน</a></li>
                            </ul>
                        </li>
                        <?php endif; ?>
