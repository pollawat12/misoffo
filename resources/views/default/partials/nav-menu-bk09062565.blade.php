    ...
    <div class="slimscroll-menu">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu" id="side-menu">
                ...
                <?php if($nav_role_id == 1 || $nav_role_id == 2 || $nav_role_id == 11):?>      
                <li>
                    <a href="javascript: void(0);">
                        <i class="fas fa-money-check-alt" style="font-size: 18px !important;"></i>
                        <span> งบประมาณ </span>
                ...
                <?php endif; ?>
                <?php if($nav_role_id == 1 || $nav_role_id == 2 || $nav_role_id == 12):?>              
                <li>
                    <a href="javascript: void(0);">
                ...
                <?php endif;?>
                <?php if($nav_role_id == 1 || $nav_role_id == 2 || $nav_role_id == 13):?>              
                <li>
                    <a href="javascript: void(0);">
                ...
                <?php if($nav_role_id == 1 || $nav_role_id == 2 || $nav_role_id == 9):?>       
                <li>
                    <a href="javascript: void(0);">
                ...
                <?php endif; ?>
                <?php if($nav_role_id == 1 || $nav_role_id == 2 || $nav_role_id == 10):?>       
                <li>
                    <a href="javascript: void(0);">
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        <li>
                            ...
                            <ul class="nav-third-level nav" aria-expanded="false">
                                <li><a href="{{URL('office/durable/lists')}}/?t=durable&pr=0">ข้อมูลพัสดุ</a></li>
                                <li><a href="{{URL('office/durable/borrow/lists')}}/?t=borrow&pr=0">เบิก / ยืม / คืน พัสดุ</a></li>
                                {{-- <li><a href="{{URL('office/durable/activity')}}/?t=returns&pr=0">คืนพัสดุ</a></li> --}}
                                <li><a href="{{URL('office/durable/activity')}}/?t=distribution&pr=0">จำหน่ายพัสดุ</a></li>
                                <li><a href="{{URL('office/durable/repair')}}/?t=repair&pr=0">ซ่อมแซมพัสดุ</a></li>
                            </ul>
                        </li>
                ...
                <?php if($nav_role_id == 1 || $nav_role_id == 2 || $nav_role_id == 14):?>      
                <li>
                    <a href="javascript: void(0);">
                        <i class="fas fa-chalkboard-teacher" style="font-size: 18px !important;"></i>
                        <span> ยุทธศาสตร์ </span>
                    ...
                    <ul class="nav-second-level nav" aria-expanded="false">
                            ...
                            <ul class="nav-third-level nav" aria-expanded="false">
                                ...
                                <li>
                                    ...
                                    <ul class="nav-third-level nav" aria-expanded="false">
                                        ...
                                        <li><a href="{{URL('office/strategic/oil/import/lists')}}/?t=cargo&pr=11"><i class="fas fa-angle-right mr-1"></i>  CP</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav-third-level nav" aria-expanded="false">
                                <li>
                                    <li><a href="{{URL('office/strategic/oil/lists')}}/?t=exchange&pr=4"><i class="fas fa-angle-right mr-1"></i> อัตราแลกเปลี่ยนเงิน</a></li>
                ...
                <?php if($nav_role_id == 1 || $nav_role_id == 2):?>    
