                        ...
                        <table id="datatable" class="table table-bordered table-striped  dt-responsive nowrap"
                            ...
                            <thead>
                                <tr class="bg-dark text-white">
                                    ...
                                    <th rowspan="2" style="width: 14%; vertical-align : middle;text-align:center;">รายการ</th>
                                    <th rowspan="2" style="vertical-align : middle;text-align:center;">หน่วย</th>
                                    <th colspan="5" style="vertical-align : middle;text-align:center;">จำนวนของรายการ</th>
                                    <th rowspan="2" style="vertical-align : middle;text-align:center;">หมายเหตุ</th>
                                </tr>
                                <tr class="bg-dark text-white">
                                    <th style="vertical-align : middle;text-align:center;">ยกมา</th>
                                    <th style="vertical-align : middle;text-align:center;">รับ</th>
                                    <th style="vertical-align : middle;text-align:center;">รวม</th>
                                    <th style="vertical-align : middle;text-align:center;">จ่าย</th>
                            ...
                            <tbody>
                                ...
                                <?php
                                    $Checkitems = \App\Models\DurableAmount::where('durable_id', $item['id'])->where('is_deleted', '0')->where('is_active','1')->sum('distribute_num');
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle" style="vertical-align : middle;text-align:center;">{{$Checkitems}}</td>
