! function (c) {
    ...
    e.prototype.createLineChart = function (e, t, a, o) {
        ...
        e.createPieChart(c("#3d-exploded-chart")[0], l, ["#5553ce", "#297ef6", "#e52b4c", "#ffa91c", "#32c861", "#353d4a"], !0, !0), c(window).on("resize", function () {
            e.createLineChart(c("#line-chart")[0], t, "Sales and Expenses", ["#4bd396", "#f5707a"]), e.createAreaChart(c("#area-chart")[0], t, "Sales and Expenses", ["#4bd396", "#f5707a"]), e.createColumnChart(c("#column-chart")[0], a, "Sales and Expenses", ["#4bd396", "#f5707a", "#3ac9d6"]), e.createBarChart(c("#bar-chart")[0], o, ["#4bd396", "#f5707a"]), e.createColumnStackChart(c("#column-stacked-chart")[0], r, "Sales and Expenses", ["#188ae2", "#4bd396", "#f9c851", "#f5707a", "#6b5fb5", "#3ac9d6"]), e.createBarStackChart(c("#bar-stacked-chart")[0], n, ["#188ae2", "#4bd396", "#f9c851", "#f5707a", "#6b5fb5", "#3ac9d6"]), e.createPieChart(c("#pie-chart")[0], i, ["#188ae2", "#4bd396", "#f9c851", "#f5707a", "#6b5fb5"], !1, !1), e.createDonutChart(c("#donut-chart")[0], i, ["#188ae2", "#4bd396", "#f9c851", "#f5707a", "#6b5fb5"]), e.createPieChart(c("#pie-3d-chart")[0], i, ["#188ae2", "#4bd396", "#f9c851", "#f5707a", "#6b5fb5"], !0, !1), e.createPieChart(c("#3d-exploded-chart")[0], l, ["#188ae2", "#4bd396", "#f9c851", "#f5707a", "#6b5fb5"], !0, !0)
        })
