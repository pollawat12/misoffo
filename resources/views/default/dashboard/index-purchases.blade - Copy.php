        ...
        <div class="row">
                ...
                <div class="card-box widget-box-three">
                    <div class="media">
                        <div class="avatar-lg bg-icon rounded-circle align-self-center">
                            <img class="avatar-sm" src="{{url('assets/default')}}/images/icons/clock.svg" title="clock.svg">
                        </div>
                        <div class="wigdet-two-content media-body text-right">
                            <p class="mt-1 text-uppercase font-weight-medium">รายการทั้งหมด (ปี 2564)</p>
                            <h2 class="mb-2"><span data-plugin="" style="font-size: 22px !important;">0</span></h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-sm-6">
                <div class="card-box widget-box-three">
                    <div class="media">
                        <div class="avatar-lg bg-icon rounded-circle align-self-center">
                            <img class="avatar-sm" src="{{url('assets/default')}}/images/icons/advertising.svg" title="advertising.svg">
                        </div>
                        <div class="wigdet-two-content media-body text-right">
                            <p class="mt-1 text-uppercase font-weight-medium">จำนวนเงินทั้งหมด (ปี 2564)</p>
                            <h2 class="mb-2"><span data-plugin="" style="font-size: 22px !important;">0</span></h2>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-sm-6">
                <div class="card-box widget-box-three">
                    <div class="media">
                        <div class="avatar-lg bg-icon rounded-circle align-self-center">
                            <img class="avatar-sm" src="{{url('assets/default')}}/images/icons/paid.svg" title="paid.svg">
                        </div>
                        <div class="wigdet-two-content media-body text-right">
                            <p class="mt-1 text-uppercase font-weight-medium">รายการที่ยังไม่แล้วเสร็จ</p>
                            <h2 class="mb-2"><span data-plugin="" style="font-size: 22px !important;">0</span></h2>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box table-responsive">
                    <h4 class="header-title">สรุปรายการจัดซื้อ-จัดจ้าง (ยังไม่แล้วเสร็จ)</h4>
                    <p class="sub-header">
