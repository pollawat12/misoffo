...
<div class="content">
    ...
    <div class="container-fluid">
            ...
            <div class="col-md-12">
                <div class="card-box">
                    ...
                    <form action="{{url('office/budget/confirm/update')}}" method="POST" name="frm-save" id="frm-save">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="input[year_budgets_id] " class="form-control"] style="height: 45px;">
                                        ...
                                        <option value="{{$valYear->id}}" @if($valYear->id == $info->year_budgets_id) selected @endif>ปีงบประมาณ {{$valYear->in_year}} ระหว่าง เดือน {{getDateMonthTH($valYear->date_start)}} - {{getDateMonthTH($valYear->date_end)}}</option>
                                        @endforeach
                                        @endif
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="input[cost_type] " class="form-control"] style="height: 45px;">
                                        <option value="">--เลือก--</option>
                                        <option value="1" @if(1 == $info->cost_type) selected @endif>จำนวนเงินโอน</option>
                        ...
                        <a href="{{URL('office/budget/confirm/show')}}/{{$projectsId}}/?t=2"  class="btn btn-secondary"><i class=" mdi mdi-backspace-outline
                            "> ยกเลิก</i></a>
                    </form>
                </div>
            </div>
        ...
        <!-- end row -->
        <div id="url-redirect-back" data-url="{{url('office/budget/confirm/show')}}/{{$projectsId}}/?t=2"></div>
    </div>
</div>
@endsection
