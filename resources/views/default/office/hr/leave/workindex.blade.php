                    ...
                    <table id="datatable" class="table table-bordered table-striped  dt-responsive nowrap"
                        ...
                        <tbody>
                            ...
                            <?php $no++;
                                 ...
                                 $LeaveNum = \App\Models\Userleave::where('users_id', $id)->where('leave_type', $item['id'])->whereIn('is_approved', ['4','5'])
                                                                    ->where('is_deleted', '0')->where('is_active','1')->get();
                            ...
                            <tr>
                                ...
                                ?>
                                        ...
                                        <td class="align-middle">{{$Leave['number_date'] + $item['data_value'] - $LeaveNumCount2}}</td>
