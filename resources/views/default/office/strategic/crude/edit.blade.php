...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">แก้ไข PLATT'S CRUDE OIL PRICES</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-box">
                    <h4 class="header-title mb-4"><i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; "> แก้ไขข้อมูล PLATT'S CRUDE OIL PRICES</i> </h4>
                       ...
                       <input type="hidden" name="action" value="edit">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="dob">BUYING (US EX.RATE(B/$))</label>
                                    <div>
                                        <div class="input-group">
                                            <input type="text" name="input[oil_price_buying]" class="form-control" placeholder="" style="height: 45px;" value="{{$info->oil_price_buying}}">
                                        </div><!-- input-group -->
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="dob">SELLING (US EX.RATE(B/$))</label>
                                    <div>
                                        <div class="input-group">
                                            <input type="text" name="input[oil_price_selling]" class="form-control" placeholder="" style="height: 45px;" value="{{$info->oil_price_selling}}">
                                        </div><!-- input-group -->
                                    </div>
                                </div>
                            </div>
                    ...
                    <h4 class="header-title mb-4">
                        <i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; "> รายละเอียด</i> </h4>
                            ...
                            <thead>
                                ...
                                <?php $type = \App\Models\DataSetting::getNameDataByValueAndType($item['oil_type'],'oilType'); ?>
                                <?php $no++;?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="oil_max[{{$item['id']}}]" class="form-control" placeholder="" style="height: 45px;" value="{{$item['oil_max']}}">
                                        </td>
                                    </tr> 
                                </tbody>
                                @endforeach
