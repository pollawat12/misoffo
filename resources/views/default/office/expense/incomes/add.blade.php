...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <!-- end page title -->
        <form action="{{url('office/expenses/incomes/save')}}" method="POST" name="frm-save" id="frm-save">

        <div class="row">
            <div class="col-md-12">
                <div class="card-box">
                    <h4 class="header-title mb-4"><i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; "> รายได้ของเงินกองทุน</i> </h4>
        ...
        <div id="url-redirect-back" data-url="{{url('office/expenses/incomes/edit')}}"></div>
    </div>
</div>
@endsection
