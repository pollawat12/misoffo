...
<table id="datatable" >
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-middle">@if ($item['borrow_date'] != NULL) {{getDateShow($item['borrow_date'])}} @endif</td>
            <td class="align-middle">{{$item['borrow_user_name']}}</td>
            <td class="align-middle">{{$item['borrow_location']}}</td>
            <td class="align-middle">@if ($item['returns_date'] != NULL) {{getDateShow($item['returns_date'])}} @endif</td>
