                ...
                <div class="card-box table-responsive">
                    <div class="row mb-3">
                        ...
                        <div class="col-6 text-right">
                            <!-- <a href="{{url('office/budget/expenses/project/add')}}" class="btn btn-secondary"><i class="mdi mdi-file-document-box-plus-outline"> เพิ่มข้อมูล</i></a> -->
                        </div>
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php 
                                    ...
                                    $budgetCategroys = \App\Models\BudgetYear::getdata($row->in_year); 
                                    foreach ($budgetCategroys as $rowBudgetCategroys)
                                ?>
                                <td class="align-middle">{{$rowBudgetCategroys['year_name']}}</td>
                                ...
                                <td>
                                    ...
                                    <select name="input_action" class="form-control " data-id="{{$row->id}}">
                                        ...
                                        <option value="show" >รายงาน</option>
                                    </select>
                                </td>
                            </tr> 
                            @endforeach
