...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">นำเข้าข้อมูล Exchange Rate</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-icon alert-info text-info alert-dismissible fade show p-3" role="alert" style="color: black !important;">
                    ...
                    <strong>แจ้งเตือน!</strong> กำลังทำการอัพโหลดไฟล์ข้อมูล Exchange Rate
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-box">
                    <h4 class="header-title mb-4"><i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; "> นำเข้าข้อมูล Exchange Rate</i> </h4>
