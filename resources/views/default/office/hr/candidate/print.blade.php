...
<div class="content">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="media-body">
                <div class="p-4">
                            ...
                            <thead>
                                <tr class="text-center">
                                    <th style="width: 5%;" class="text-color-td table-border-color custom-table"
                                        rowspan="2">
                                        ลำดับที่</th>
                                    <th style="width: 20%;" class="text-color-td table-border-color custom-table"
                                        rowspan="2">
                                        รายชื่อผู้สมัคร</th>
                                    <th class="text-color-td table-border-color custom-table" colspan="<?php if (!empty($directors)){ echo count($directors);}?>">
                                        ผลคะแนนการประเมินผู้เข้ารับการสัมภาษณ์
                                        โดยคณะกรรมการสรรหาและคัดเลือกฯ</th>
                                    <th class="text-color-td table-border-color custom-table" rowspan="2"
                                        style="width: 10%;">คะแนนเฉลี่ย</th>
                                    <th class="text-color-td table-border-color custom-table" rowspan="2"
                                        style="width: 10%;">หมายเหตุ</th>
                                </tr>
                                <tr class="text-center">
                                    @if (!empty($directors))
                    ...
                    <h6 class="font-16 mb-2 mt-3 text-center color-text">คณะกรรมการฯ รับทราบผลประเมิน
                        และเห็นควรให้ดำเนินการต่อไป</h6>
        ...
        <div class="col-md-6">
            <h6 class="font-14 mb-3 text-center color-text">ลงชื่อ
                .........................................................................................
                ประธานกรรมการ</h6>
            <h6 class="font-14 mb-3 text-center color-text">
                (..................................................................................................................)</h6>
        </div>
        <div class="col-md-6">
            <h6 class="font-14 mb-3 text-center color-text">ลงชื่อ
