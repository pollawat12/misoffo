...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">แสดง ประเภทงบ</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-box">
                    <h4 class="header-title mb-4"><i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; "> เพิ่มข้อมูล ประเภทงบ</i> </h4>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="input[parent_id]" class="form-control" id="input-parent_id" style="height: 45px;">
                                        ...
                                        @foreach ($statementtypes as $statementtype)
                                            <option value="{{$statementtype['id']}}">{{$statementtype['name']}}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="input[name]" class="form-control" id="input-name" placeholder="ประเภทงบ" style="height: 45px;">
