                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="input-group">
                                            <input type="text" name="input[oil_price_propane]" class="form-control" placeholder="" style="height: 45px;" value="{{$info->oil_price_propane}}">
                                        </div><!-- input-group -->
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="input-group">
                                            <input type="text" name="input[oil_price_butane]" class="form-control" placeholder="" style="height: 45px;" value="{{$info->oil_price_butane}}">
                                        </div><!-- input-group -->
                                    </div>
                                </div>
                            </div>
