...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <form action="{{url('office/expenses/certificate/save')}}" method="POST" name="frm-save" id="frm-save" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                    <div class="card-box">
                        <h4 class="header-title mb-4"><i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; "> เพิ่มข้อมูล ใบสำคัญจ่าย</i> </h4>
                            ...
                            <input type="hidden" name="input[type_id]" id="type_id" value="{{$t}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <div class="input-group">
                                                <input type="text" class="form-control datepicker-autoclose" style="height: 45px;" placeholder="วว/ดด/ปปปป"  name="input[certificate_date]" value="{{getDateFormatToInputThai(date('Y-m-d'))}}">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <div class="input-group">
                                                <input type="text" class="form-control datepicker-autoclose" style="height: 45px;"  placeholder="วว/ดด/ปปปป"  name="input[certificate_check_date]">
                                                <div class="input-group-append">
                                                    <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                                </div>
                                            </div><!-- input-group -->
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea  name="input[certificate_note]" class="form-control"></textarea>
                ...
                <div class="col-md-12">
                    <div class="card-box">
                        <h4 class="header-title mb-4"><i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; "> ข้อมูลรายละเอียด</i> </h4>
                                ...
                                <a href="{{URL('office/expenses/certificate/all')}}?t={{$t}}&pr={{$pr}}"  class="btn btn-secondary"><i class=" mdi mdi-backspace-outline
                                    "> ยกเลิก</i></a>
        ...
        <!-- end row -->
        <div id="url-redirect-back" data-url="{{url('office/expenses/certificate/all')}}?t={{$t}}&pr={{$pr}}"></div>

        <div data-url="{{URL('office/expenses/certificate')}}" id="base-url-api"></div>
    </div>
</div>
@endsection
...
$(document).on("change", "#certificate_payfor", function(){
    ...
    $('#loadDetail').load('{{URL('office/expenses/certificate/get/loadDetail')}}' + '/' + _itemValue  + '/' + _id);
