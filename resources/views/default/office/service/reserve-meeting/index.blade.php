                    ...
                    <table id="datatable" class="table table-bordered table-striped  dt-responsive "
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">@if($item->status_approved == '0') <span class="badge bg-warning badge-pill text-dark" style="font-size: 14px; padding:8px">รออนุมัติ</span>
                                     @elseif($item->status_approved == '1') <span class="badge bg-success badge-pill" style="font-size: 14px; padding:8px 16px 8px 16px">อนุมัติ </span>@else ไม่อนุมัติ @endif</td>
                                <td class="align-middle">
                                    ...
                                    @else 
                                        <select name="input_action" class="form-control" >
                                            <option value="">เลือก</option>
                                            @if($auth_info['user_id'] == $item->user_id)
                                            <option value="edit" data-id="{{ $item->id }}">แก้ไข</option>
                                            @else 
                                            {{-- <option value="edit" data-id="{{ $item->id }}">{{ $item->id }}</option> --}}
