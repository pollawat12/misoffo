        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">แก้ไข รายได้</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        <form action="{{url('office/incomes/update')}}" method="POST" name="frm-save" id="frm-save" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-12">
                    <div class="card-box">
                        <h4 class="header-title mb-4"><i class="mdi mdi-file-document-box-plus" style="font-size: 16px !important; "> ข้อมูลรายได้</i> </h4>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="input[incomes_company]" id="incomes_company" class="form-control" style="height: 45px;">
                                            ...
                                            <option value="{{$valcompany->id}}" @if($valcompany->id == $info->incomes_company) selected @endif>{{$valcompany->company_name}}</option>
                                            @endforeach
                                            @endif
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <div class="input-group">
                                                <input type="text" class="form-control datepicker-autoclose"  placeholder="วว/ดด/ปปปป"  name="input[incomes_day]" value="@if ($info->incomes_day != NULL){{getDateFormatToInputThai($info->incomes_day)}} @endif">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="input[incomes_status]" id="incomes_status" class="form-control" style="height: 45px;">
                                            <option value="">--เลือก--</option>
                                            <option value="1" @if($info->incomes_status == 1) selected @endif>ดำเนินการ</option>
                                            <option value="2" @if($info->incomes_status == 2) selected @endif>ตราจสอบ</option>
                                            <option value="3" @if($info->incomes_status == 3) selected @endif>อนุมัติ</option>
                                            <option value="4" @if($info->incomes_status == 4) selected @endif>จัดส่งรายการ</option>
                                            <option value="5" @if($info->incomes_status == 5) selected @endif>ยกเลิก</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea  name="input[incomes_note]" class="form-control">{{$info->incomes_note}}</textarea>
                                    ...
                                    <div class="row fname" id="firstTr">
                                        <div class="col-md-6" >
                                            <div class="form-group">
                                                ...
                                                <select name="oil_type_id[]" id="oil_type_id" class="form-control" style="height: 40px;">
                                                    ...
                                                    <option value="{{$valoil->id}}" @if($valoil->id == $item['oil_type_id']) selected @endif>{{$valoil->name}}</option>
                                                    @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-6" >
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="export_total[]"  class="form-control" placeholder="" style="height: 45px;" value="{{$item['export_total']}}">
                                                <small id="incomes_note" class="form-text text-muted"></small>    
                                            </div>
                                        </div>
                                    </div>
