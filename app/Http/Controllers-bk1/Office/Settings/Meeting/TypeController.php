...
class TypeController extends Base 
{    
    /**
     * index
     *
    ...
    {
        $types = DataSetting::getDataAll('meeting_type');
        
        # code...
        $data = ['types'];
        return view('default.office.setting.meeting.type.index', compact($data))->render();
    }
    ...
    public function add(Request $request)
    {
        ...
        # code...
        $data = [];
        return view('default.office.setting.meeting.type.add', compact($data))->render();
    }
    ...
    public function edit($id, Request $request)
    {
        ...
        # code...
        $data = ['_info', 'id'];
        return view('default.office.setting.meeting.type.edit', compact($data))->render();
    }
